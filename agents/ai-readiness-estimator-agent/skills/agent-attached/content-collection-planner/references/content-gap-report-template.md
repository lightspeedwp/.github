...
```markdown
# [Client Name] - Content Gap Report

- Value: Shows what content exists, what is missing and what must be approved before website, AI or chatbot work proceeds.
- Risk: Weak or outdated source material can lead to inaccurate website copy, poor SEO and unsafe chatbot answers.
- Next step: Assign owners and deadlines for priority content gaps.

## Evidence reviewed

[List documents, pages, folders, spreadsheet tabs or notes reviewed.]

## Summary

[Short summary of current content health.]

## Priority gaps

| Gap | Impact | Needed for | Owner | Priority | Notes |
|---|---|---|---|---|---|
|  | Website / Governance / Chatbot / Compliance |  |  | High/Med/Low |  |

## Source-of-truth register

| Source | Current? | Approved? | Owner | Suitable for chatbot? | Notes |
|---|---|---|---|---|---|
|  |  |  |  |  |  |

## Content request checklist

[Insert tailored checklist.]

## Chatbot suitability notes

[Identify which content may be used for chatbot grounding and which must be excluded.]

## Recommended next step

[Content collection, rewrite sprint, policy review, sitemap planning, governance guide or chatbot readiness review.]
```
