...
- missing values called out clearly
- custom-scope triggers surfaced when relevant
- estimate output follows the required template
- proposal output follows the required template
