...
- any custom-scope trigger is present
- the output contains assumptions that materially affect price or delivery
- the estimator is relying on incomplete audit evidence
- the proposal includes sensitive, regulated, or higher-risk AI use cases
