...
- major CRM, ERP, booking, marketplace, or enterprise integrations
- bespoke application behaviour or custom product development
- complex regulated, privacy-sensitive, or restricted advice workflows
- substantial content contradictions or remediation needs
...
- Chatbot Starter: custom if integrations, multilingual design, product-aware logic, or complex workflows are needed.
- Chatbot Tailored: custom if major integrations, bespoke application logic, or regulated advice flows are required.
- Yoast Training: custom if the work expands into strategy, copy delivery, or multi-team programme design.
