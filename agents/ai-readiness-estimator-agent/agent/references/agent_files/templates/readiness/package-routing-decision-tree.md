...
Choose the **base package first**.
Do not recommend add-ons, implementation scope, or broader follow-on work until the base route is justified by the evidence.

---

## Step 1: Check the Evidence Quality
...
- project goal
- delivery type
- major integrations or constraints
...
## Step 2: Decide Whether This Is Baseline Readiness Work

Choose **AI Readiness Foundation** when the evidence suggests the client needs a baseline review of:
...
- the client needs overall direction before scope can be confirmed
- discovery is still early and commercial confidence should remain provisional

**Default rule:** if the opportunity looks like general baseline readiness work, route to **AI Readiness Foundation**.

---

## Step 3: Check for a Chatbot-First Brief

Do **not** choose a chatbot route only because chatbot work may happen later.
...
## Step 4: Check for a Specialist Route Instead of Foundation
...
- the main need is clearly plugin, platform, or implementation-feasibility review
...
## Step 5: Decide Whether This Should Move to Custom Scope
...
- bespoke product or application behaviour
- complex regulated, privacy-sensitive, or restricted workflows
...
- what still needs to be confirmed before the recommendation can be treated as commercially dependable
