...
| Recommended base package | AI Readiness Foundation |
| Confidence | [Low / Medium / High] |
| Status | [Provisional / Audit-first / Approval-dependent / Custom-scope] |
| Immediate next step | [Insert next step] |
...
The estimate cannot move beyond a provisional audit-first position until these values are sourced or confirmed:
...
The recommendation should move out of standard fixed-fee handling if later evidence shows any of the following:
