...
- Content Restructure Sprint
- Website Redesign / Rebuild
- WordPress Block Theme Implementation
- WooCommerce Implementation
- Tour Operator Website Implementation
- Publisher Website Implementation
- Education / LMS Website Implementation
- AI Chatbot Planning
- AI Engine Chatbot Implementation
...
- source list
- exclusion list
- fallback and escalation wording
- launch gate
- test scripts
