...
- implementation planning for agreed priority schema types
- robots.txt and crawl-policy review
- llms.txt recommendation and implementation guidance where appropriate
...
- Is the site multilingual or multi-brand?
...
- blog, FAQ, product, article, and service content presence
- WooCommerce status
- multilingual or multi-brand status
- integrations or headless architecture notes
- current SEO plugin status
