...
describe('metadata-extraction skill', () => {
  ...
  describe('extractMetadata', () => {
    it('extracts block-plugin metadata', () => {
      ...
      fs.writeFileSync(path.join(tempDir, 'block.json'), JSON.stringify(blockJson));
    ...
    it('extracts block-theme metadata', () => {
      ...
      fs.writeFileSync(path.join(tempDir, 'theme.json'), JSON.stringify(themeJson));
      fs.writeFileSync(path.join(tempDir, 'style.css'), 'Text Domain: my-theme');
