...
const os = require('os');
const { generateBadges, formatBadgesAsMarkdown, injectBadges } = require('../../skills/generate-badges');
...
describe('generate-badges skill', () => {
  ...
  describe('edge cases', () => {
    it('handles missing package.json gracefully', () => {
      const result = generateBadges(tempDir, 'block-plugin');
      expect(result.success === undefined || result.success === true).toBe(true);
    });
