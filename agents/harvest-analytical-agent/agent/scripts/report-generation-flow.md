...
4. Reconcile totals across the returned data.
5. Classify risk using the current thresholds.
6. Produce the report in the appropriate template structure.
7. List assumptions, permissions limits, and data gaps.
