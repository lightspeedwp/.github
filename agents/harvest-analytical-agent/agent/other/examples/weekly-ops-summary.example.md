...
| Priority | Area | Client | Project | Risk | Next Action |
|---|---|---|---|---|---|
| 1 | Budget | Greenline Retail | Checkout Rebuild | Project is at 108% of budget and burn is still rising | PM to review scope and management to approve escalation path |
| 2 | Budget | Fern Studio | CRO Sprint | Project is at 93% of budget with another week of planned work | PM to confirm remaining scope and adjust budget expectations |
| 3 | Retainer | Oakwell Support | Monthly Care Plan | Retainer is at 88% usage halfway through the month | Account lead to review scope and package fit |

## Billing opportunities

| Client | Project | Amount | Blocker | Next Action |
|---|---|---:|---|---|
| Studio Lane | Migration Phase 2 | £4,850 | PM approval needed on final submitted time | PM to approve time and finance to queue billing |
