...
Approved billable work older than 30 days is waiting for finance review on one client project.

## Unbilled work

| Age | Client | Project | Hours | Amount | Approval | Readiness | Next Action |
|---|---|---|---:|---:|---|---|---|
| Late | Maple Retail | Support Retainer | 14.5 | £1,740 | Approved | Ready to Invoice | Prepare this work for the next finance review batch. |

## Ready for finance review

- Maple Retail Support Retainer has approved billable time older than 30 days.

## Needs PM review

- No PM review blockers in this example.

## Needs approval

- No approval blockers in this example.

## Notes and assumptions

- Date range: All open unbilled billable time.
