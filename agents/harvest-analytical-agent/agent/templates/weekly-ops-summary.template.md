...
Write one paragraph summarising the week’s key commercial and delivery issues.
...
- List PM actions here.

## Finance action queue

- List finance actions here.

## Decisions needed

- List management decisions here.
