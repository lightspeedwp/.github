# Voice and tone intake template
...
- What should a reader feel after engaging with the content?
...
- Terms or phrases to prefer:
- Terms or phrases to avoid:

## Tone by context

| Context | Tone guidance | What to avoid |
|---|---|---|

## Notes

- Approval-sensitive tone areas:
- Claim-sensitive tone areas:
