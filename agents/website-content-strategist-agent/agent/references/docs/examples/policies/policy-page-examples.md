...
This page explains what data is collected, why it is collected, and how users can contact the company about privacy matters.
...
This page explains what cookies or tracking technologies are used, why they are used, and how visitors can manage preferences.
...
This page sets out the main contractual, usage, and limitation terms for the website or service.
...
## AI governance policy example

### Policy summary

This page explains how AI may be used, where human review is required, and what governance controls shape the work.
...
## Policies and principles example

### Policy summary

This page acts as a hub for the organisation's policies, operating principles, and public governance commitments.
...
## Publishing principles example

### Policy summary

This page explains how the organisation approaches publishing standards, updates, source checks, and editorial responsibility.
...
## Ownership info example

### Ownership summary

- Legal entity: Example Agency Ltd
- Trading name: Example Agency
- Website owner: Example Agency Ltd
- Content owner: Internal editorial team
...
This page explains how feedback is collected, what routes are available, and how the organisation reviews and responds.
...
## Corrections policy example

### Policy summary

This page explains how corrections are reported, reviewed, and recorded when published content needs updating.

### Sections

- Reporting a correction
- Verification and update process
- Clarification vs correction rules

---

## Ethics policy example

### Policy summary

This page explains the ethical principles that influence the organisation's decisions, conduct, and public-facing work.
...
This page explains the organisation's diversity commitments, review standards, and accountability approach.
