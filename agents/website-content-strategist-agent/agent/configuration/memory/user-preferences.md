...
- No confirmed reusable preferences saved yet.

## Formatting preferences

- No confirmed formatting preferences saved yet.

## Workflow preferences

- No confirmed workflow preferences saved yet.
...
- Private or sensitive data that does not need to persist
