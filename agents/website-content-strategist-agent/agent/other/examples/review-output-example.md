...
- **Recommended workflow:** Confirm proof points, complete the intake gaps, then move into the matched drafting workflow.
- **Validation checks:** The matched template exists, required headings are present, and no placeholder text remains.
