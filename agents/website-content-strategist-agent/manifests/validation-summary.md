...
- Agent files discovered: 204
- Agent files exported: 204
- Skills discovered: 67
- Fully exported skills: 67
- Partially exported skills: 0
- Metadata-only skills: 0
- Skill folder comparison mismatches: 0
- Inaccessible copy attempts: 0
- Redaction entries: 19
- Empty exported files: 0
- Duplicate file-content groups: 31
