...
| --- | --- | --- | --- |
| `agent/references/docs/intake/README.md` | line 33 | OpenAI-style key | `[REDACTED_OPENAI_KEY]` |
| `agent/references/docs/intake/README.md` | line 70 | OpenAI-style key | `[REDACTED_OPENAI_KEY]` |
| `agent/references/docs/intake/README.md` | line 105 | OpenAI-style key | `[REDACTED_OPENAI_KEY]` |
| `agent/references/docs/intake/agent-context-routing-template.md` | line 324 | OpenAI-style key | `[REDACTED_OPENAI_KEY]` |
| `agent/references/docs/intake/approval-gate-checklist.md` | line 235 | OpenAI-style key | `[REDACTED_OPENAI_KEY]` |
| `agent/references/docs/intake/blocking-gaps-checklist.md` | line 259 | OpenAI-style key | `[REDACTED_OPENAI_KEY]` |
| `agent/references/docs/intake/claim-register-template.md` | line 286 | OpenAI-style key | `[REDACTED_OPENAI_KEY]` |
| `agent/references/docs/intake/exclusions-register.md` | line 335 | OpenAI-style key | `[REDACTED_OPENAI_KEY]` |
| `agent/references/docs/intake/handoff-output-template.md` | line 456 | OpenAI-style key | `[REDACTED_OPENAI_KEY]` |
| `agent/references/docs/intake/questionnaire-source-map.md` | line 322 | OpenAI-style key | `[REDACTED_OPENAI_KEY]` |
| `agent/references/docs/intake/smart-defaults-register.yaml` | line 233 | OpenAI-style key | `[REDACTED_OPENAI_KEY]` |
| `agent/references/docs/intake/source-approval-register.md` | line 339 | OpenAI-style key | `[REDACTED_OPENAI_KEY]` |
| `agent/references/docs/intake/url-evidence-token-schema.yaml` | line 234 | token-like value | `[REDACTED_TOKEN]` |
| `agent/references/docs/intake/url-evidence-token-schema.yaml` | line 249 | token-like value | `[REDACTED_TOKEN]` |
| `agent/references/docs/intake/url-evidence-token-schema.yaml` | line 279 | OpenAI-style key | `[REDACTED_OPENAI_KEY]` |
| `skills/platform-managed/skill-installer/scripts/github_utils.py` | line 12 | token-like value | `[REDACTED_TOKEN]` |
