...
## Primary audiences and intent

| Audience | Intent | Main need | Main friction |
|---|---|---|---|

## User-flow map

| Entry point | Next step | Conversion action | Notes |
|---|---|---|---|

## Page or asset contribution

| Page or asset | Role in user flow | Primary CTA | Support needed |
|---|---|---|---|
