...
- claim register -> claim register structure
- form specification -> form specification structure
- responder email -> newsletter or form specification structure, depending on context
