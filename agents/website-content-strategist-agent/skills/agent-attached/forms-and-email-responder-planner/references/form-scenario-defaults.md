...
- fallback: lower-friction route or manual review
...
- qualification: low
- fallback: simple confirmation plus resource route
...
- fallback: alternate support route if urgent
- responder tone: calm and expectation-setting
