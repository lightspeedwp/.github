...
1. Keep spreadsheet edits narrow when they are part of the request.
...
1. Capture the placeholder footprint from the live slide.
...
1. Replace the placeholder with the existing Sheets chart.
