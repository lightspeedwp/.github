...
- Do not invent a skills directory, skills reference file, or extra attached skills unless they are grounded in the current setup.
- If no dedicated skills directory exists in the current pack, report that clearly instead of validating an assumed one.
...
- review starter prompts, validation docs, README notes, and prompt-library docs only where they materially affect skills-routing truthfulness
- validate any skills-directory or skills-structure claims against the real current file tree and attached-skill setup
...
- skill names and purposes are described consistently across instructions and docs
- skills-related docs do not refer to missing folders, missing skill files, or stale workflow names
- starter prompts do not promise a skill-driven workflow that the current routing no longer supports
