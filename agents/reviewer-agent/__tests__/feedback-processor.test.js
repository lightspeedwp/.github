  ...
  describe("process", () => {
    ...
    test("should process all tool types in one call", () => {
      const input = {
        ...
        codeQuality: [
          { path: "b.js", line: 20, message: "Bad style", severity: "warning" },
        ],
        copilot: [
          { file: "c.js", line: 30, message: "Suggestion", severity: "note" },
        ],
        wordPressQuality: [
          { file: "d.php", line: 40, message: "WP issue", severity: "info" },
        ],
      };
  ...
  describe("reset", () => {
    test("should clear all findings", () => {
      processor.addFindings(
        processor.convertCodeRabbit([
          { file: "a.js", line: 1, title: "Issue" },
        ]),
      );
