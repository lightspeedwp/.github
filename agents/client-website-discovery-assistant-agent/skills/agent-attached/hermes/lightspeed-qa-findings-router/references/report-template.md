# QA Findings Triage Report Template
...
```markdown
# [Project] - QA Findings Triage Report

- Value: [what this triage clarifies]
- Risk: [main launch/user/business risk]
...
| ID | Finding | Source | Evidence quality | Affected area | Severity | Launch status | Workstream | Owner role | Specialist route | Next action |
|---|---|---|---|---|---|---|---|---|---|---|

## Launch blocker list

| ID | Blocker | Impact | Required fix | Owner role | Retest requirement | Status |
|---|---|---|---|---|---|---|

## Workstream routing

| Workstream | Findings | Owner role | Specialist route | Next action |
|---|---:|---|---|---|
...
## Related specialist route

## Internal LightSpeed notes

## Retest checklist

| Finding ID | Original steps retested | Desktop | Tablet | Mobile | Accessibility | Analytics/SEO/schema if relevant | Result | Notes |
|---|---|---|---|---|---|---|---|---|

## Duplicate / invalid / out-of-scope / needs reproduction

| ID | Status | Reason | Canonical item or next action |
|---|---|---|---|
