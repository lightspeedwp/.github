...
- Audit date:
- Access level:
- Yoast products detected:
- Overall readiness: ready / partially ready / not ready
- Highest-risk finding:

## 2. Findings

| Severity | Area | Finding | Evidence | Recommendation | Retest |
|---|---|---|---|---|---|

## 3. Configuration review

| Area | Current state | Recommended state | Risk | Evidence confidence |
|---|---|---|---|---|

## 4. Output QA

| URL/type | Title | Description | Canonical | Robots | Sitemap | Schema | Notes |
|---|---|---|---|---|---|---|---|
