# WooCommerce content and blog profile
...
WooCommerce stores with supporting posts, buying guides, category education, authors, dates, archives, evergreen product advice, or high-volume publishing around products. Use this profile only when the editorial content supports a WooCommerce catalogue or transactional store.

## Product posture

Yoast SEO Free can manage baseline metadata and sitemaps for supporting content. Premium, WooCommerce SEO, or News SEO should only be recommended after verifying current requirements, product scope, and whether the content supports the WooCommerce store.
