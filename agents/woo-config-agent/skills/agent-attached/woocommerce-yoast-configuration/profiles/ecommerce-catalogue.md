...
Stores where products are browsed but transactions happen offline, via enquiry, or on another platform.

## Product posture

Yoast SEO plus Yoast WooCommerce SEO should be considered when product schema, product metadata, and variation handling matter.
