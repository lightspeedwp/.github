...
- Refund, cancellation, subscription, tax, fulfilment, and order ownership are out of scope unless explicitly approved.
...
- Membership, subscriptions, tax, checkout, or fulfilment logic is really WooCommerce architecture rather than Gravity Forms configuration.
