...
- [ ] Agent profiles exist for WordPress and WooCommerce agents.
...
- [ ] Rollout owner has attached the skill to the target agents.
...
- [ ] Confirm test prompts 96-105 exist and cover Post Fields, APC, missing CPTs, auto-publishing risk, media-library mapping, taxonomy creation, business listings, editor handoff, post editing, and WooCommerce product route-away.
