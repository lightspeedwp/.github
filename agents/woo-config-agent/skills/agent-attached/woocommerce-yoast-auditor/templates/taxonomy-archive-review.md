...
- Environment:
- Exclusions:
- Output type: Taxonomy/archive review
...
| Taxonomy/archive | Term/archive URL | Indexation status | Canonical status | Metadata status | Sitemap status | Evidence status | Priority | Confidence | Risk | Recommendation | Owner / next route | Retest |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
|  |  |  |  |  |  |  |  |  |  |  |  |  |
