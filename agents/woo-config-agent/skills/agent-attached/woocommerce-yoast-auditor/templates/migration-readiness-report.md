# Yoast Migration Readiness Report
...
[Plain-English summary of migration SEO readiness, highest risks and safest next step.]
...
- New site/domain:
- URL changes:
- Content/taxonomy changes:
- WooCommerce changes:
- Output type: Migration readiness report
...
| Area | Finding | Evidence status | Evidence | Priority | Confidence | Risk | Recommendation | Owner / next route | Retest |
|---|---|---|---|---|---|---|---|---|---|
| URL/canonical |  |  |  |  |  |  |  |  |  |
| Redirects |  |  |  |  |  |  |  |  |  |
| Metadata migration |  |  |  |  |  |  |  |  |  |
...
- [Dependency, owner, route, evidence needed]
