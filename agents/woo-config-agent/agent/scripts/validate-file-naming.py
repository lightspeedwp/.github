...
RULES = {
    ...
    "references": re.compile(r"^(?:CONNECTORS|[a-z0-9-]+(?:-standard|-conventions|-workflow))\.md$"),
    "tests": re.compile(r"^(?:test-plan|qa-checklist|regression(?:-checklist)?)-[a-z0-9-]+\.md$|^[a-z0-9-]+-(?:checklist|tests|source|workflows|readme)\.md$"),
