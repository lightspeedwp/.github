...
```markdown
# [Project] - Requirements Traceability Report

- Value: [what this confirms]
- Risk: [main delivery or launch risk]
...
| ID | Requirement | Category | Priority | Source | Owner/role | Status |
|---|---|---|---|---|---|---|

## Traceability matrix

| Requirement ID | Technical brief item | Task/epic | GitHub issue draft | Acceptance criteria | QA check | Launch gate | Coverage status |
|---|---|---|---|---|---|---|---|
...
| Gap | Severity | Required fix | Owner/role |
|---|---|---|---|

## Orphan tasks or issues

| Task/issue | Why it appears orphaned | Recommendation |
|---|---|---|
