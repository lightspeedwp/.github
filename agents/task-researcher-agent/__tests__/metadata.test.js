/**
 * Task Researcher Agent — Metadata Validation Tests
...
describe("Task Researcher Agent — Metadata Validation", () => {
  it("should have valid AGENT.md frontmatter", () => {
    ...
    expect(frontmatter.name).toBe("task-researcher");
  ...
  it("should have shared core-prompt.md", () => {
    ...
    expect(content).toContain("Task Researcher Agent");
...
describe("Task Researcher Agent — Provider Implementations", () => {
  const providers = ["claude", "copilot", "openai"];
