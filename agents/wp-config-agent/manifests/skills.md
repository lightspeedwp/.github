...
| Presentations | platform-managed | /root/.codex/skills/builtins/presentations | yes | yes | fully exported | Platform-managed skill with files exposed in the local runtime. 112 file(s) exported to `skills/platform-managed/Presentations`. |
| skill-creator | platform-managed | /root/.codex/skills/.system/skill-creator | yes | yes | fully exported | Platform-managed skill with files exposed in the local runtime. 9 file(s) exported to `skills/platform-managed/skill-creator`. |
| skill-installer | platform-managed | /root/.codex/skills/.system/skill-installer | yes | yes | fully exported | Platform-managed skill with files exposed in the local runtime. 8 file(s) exported to `skills/platform-managed/skill-installer`. |
| Spreadsheets | platform-managed | /root/.codex/skills/builtins/spreadsheets | yes | yes | fully exported | Platform-managed skill with files exposed in the local runtime. 12 file(s) exported to `skills/platform-managed/Spreadsheets`. |
| wordpress-accessibility-checker | agent-attached | /root/.codex/skills/hermes/wordpress-accessibility-checker | yes | yes | fully exported | 30 file(s) exported to `skills/agent-attached/wordpress-accessibility-checker`. |
| wordpress-audit-reporting | agent-attached | /root/.codex/skills/hermes/wordpress-audit-reporting | yes | yes | fully exported | 2 file(s) exported to `skills/agent-attached/wordpress-audit-reporting`. |
| wordpress-inspection-preflight | agent-attached | /root/.codex/skills/hermes/wordpress-inspection-preflight | yes | yes | fully exported | 2 file(s) exported to `skills/agent-attached/wordpress-inspection-preflight`. |
| wordpress-launch-readiness | agent-attached | /root/.codex/skills/hermes/wordpress-launch-readiness | yes | yes | fully exported | 2 file(s) exported to `skills/agent-attached/wordpress-launch-readiness`. |
| wordpress-remediation-planner | agent-attached | /root/.codex/skills/hermes/wordpress-remediation-planner | yes | yes | fully exported | 2 file(s) exported to `skills/agent-attached/wordpress-remediation-planner`. |
| wordpress-request-router | agent-attached | /root/.codex/skills/hermes/wordpress-request-router | yes | yes | fully exported | 2 file(s) exported to `skills/agent-attached/wordpress-request-router`. |
| wordpress-site-onboarding | agent-attached | /root/.codex/skills/hermes/wordpress-site-onboarding | yes | yes | fully exported | 3 file(s) exported to `skills/agent-attached/wordpress-site-onboarding`. |
| yoast-auditor | agent-attached | /root/.codex/skills/hermes/yoast-auditor | yes | yes | fully exported | 46 file(s) exported to `skills/agent-attached/yoast-auditor`. |
| yoast-configuration | agent-attached | /root/.codex/skills/hermes/yoast-configuration | yes | yes | fully exported | 179 file(s) exported to `skills/agent-attached/yoast-configuration`. |

## Partially exported skills

| Skill | Source type | Path or URI | Entrypoint readable | Files exportable | Export status | Notes |
| ----- | ----------- | ----------- | ------------------- | ---------------- | ------------- | ----- |
| None | n/a | n/a | n/a | n/a | n/a | None detected. |

## Metadata-only external skills

| Skill | Source type | Path or URI | Entrypoint readable | Files exportable | Export status | Notes |
| ----- | ----------- | ----------- | ------------------- | ---------------- | ------------- | ----- |
| Bugherd connector tools | platform-managed | asdk_app_6a01b491d12c8191bb07bb7bef63d403 | no | no | metadata only - source files not exposed | Visible as connected app/tool capability; no source file entrypoint exposed to the filesystem. |
| GitHub connector tools | platform-managed | connector_76869538009648d5b282a4bb21c3d157 | no | no | metadata only - source files not exposed | Visible as connected app/tool capability; no source file entrypoint exposed to the filesystem. |
| Google Drive connector tools | platform-managed | connector_5f3c8c41a1e54ad7a76272c89e2554fa | no | no | metadata only - source files not exposed | Visible as connected app/tool capability; no source file entrypoint exposed to the filesystem. |
| Linear connector tools | platform-managed | asdk_app_69a089a326dc8191b32a3f2553f5be2c | no | no | metadata only - source files not exposed | Visible as connected app/tool capability; no source file entrypoint exposed to the filesystem. |
| LS Agency Dev Site WordPress app | agent-attached | asdk_app_6a4384f18d208191b45d35341d4085cd | no | no | metadata only - source files not exposed | Visible as connected app/tool capability; no source file entrypoint exposed to the filesystem. |
| LS Agency LIVE MCP WordPress app | agent-attached | asdk_app_6a402c16266c8191ac82952d0a8b7ef7 | no | no | metadata only - source files not exposed | Visible as connected app/tool capability; no source file entrypoint exposed to the filesystem. |
