# Gravity Forms Auditor to Configuration Contract
...
Use this contract when `gravity-forms-auditor` identifies actionable Gravity Forms findings that require approved remediation by `gravity-forms-configuration`.
...
| `source_skill` | Yes | Usually `gravity-forms-auditor`. |
| `target_skill` | Yes | Usually `gravity-forms-configuration`. |
...
When receiving a handoff, `gravity-forms-configuration` must respond with:
...
| `recommended_retest` | Yes | Prompt or notes for `gravity-forms-auditor` retest. |
...
```json
{
  ...
  "source_audit": {
    ...
    "date": "2026-07-03",
    "source_skill": "gravity-forms-auditor"
  },
  "source_skill": "gravity-forms-auditor",
  "target_skill": "gravity-forms-configuration",
