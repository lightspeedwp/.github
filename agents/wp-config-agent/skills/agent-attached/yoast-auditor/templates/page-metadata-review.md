...
- Content types:
- Exclusions:
- Output type: Page metadata review
...
| URL | Content type | Current SEO title | Current meta description | Social metadata | Indexation status | Evidence status | Priority | Finding | Confidence | Risk | Recommendation | Owner / next route | Retest |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
|  |  |  |  |  |  |  |  |  |  |  |  |  |  |
