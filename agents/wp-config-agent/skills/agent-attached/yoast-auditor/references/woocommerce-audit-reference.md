...
Load only for WooCommerce, ecommerce, product, product category, product variation or shop-page audit requests.
...
- Audit existing WooCommerce SEO output: `yoast-auditor`.
- Configure WooCommerce SEO defaults, templates or schema settings: `yoast-configuration`.
