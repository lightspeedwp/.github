...
[
  ...
  },
  {
    ...
    "developer_handoff_relevance": "Use for product capability context only; route setup/defaults to yoast-configuration and code-level output changes to developer handoff.",
    "confidence": "high",
