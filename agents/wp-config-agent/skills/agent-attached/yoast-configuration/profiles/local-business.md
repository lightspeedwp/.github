...
Businesses with physical locations, service areas, local landing pages, maps, reviews, opening hours, and location-sensitive schema needs.

## Product posture

Use Yoast SEO as the base. Consider Local SEO only after verifying requirements and product scope. Do not fake local schema without accurate location data.
