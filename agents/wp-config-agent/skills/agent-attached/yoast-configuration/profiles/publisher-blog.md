...
Editorial sites with posts, categories, tags, authors, dates, archives, evergreen content, news-like workflows, and high-volume publishing.

## Product posture

Yoast SEO Free can manage baseline metadata and sitemaps. Premium may help with internal linking and orphaned content. News SEO is separate and should be verified when news-specific requirements exist.
