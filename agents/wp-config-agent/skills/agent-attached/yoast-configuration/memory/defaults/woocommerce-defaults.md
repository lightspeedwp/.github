...
- Treat product pages, product categories, product tags, shop page and filtered URLs separately.
- Index curated product categories; usually noindex thin tags and arbitrary filtered URLs.
