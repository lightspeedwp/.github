...
- [ ] The skill has QA scenarios for contact, quote, WooCommerce enquiry, tour operator, payment, and user registration forms.
...
- [ ] Full audit reports route to `gravity-forms-auditor`.
- [ ] Formal findings registers, readiness scorecards, client-safe audit summaries, retainer audit reports, and separate audit retest reports route to `gravity-forms-auditor`.
...
- [ ] Existing WordPress, WooCommerce, and Tour Operator profiles still work.
...
- [ ] Tests cover routing full audits to `gravity-forms-auditor` and remediation/troubleshooting staying in `gravity-forms-configuration`.
