...
Keep this skill centred on Gravity Forms configuration. The parent configuration agent owns broader WordPress, WooCommerce, or tour operator decisions. This skill provides form-specific planning, validation, troubleshooting, and handoff evidence.
