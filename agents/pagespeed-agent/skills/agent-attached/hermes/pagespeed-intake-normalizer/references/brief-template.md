# Normalized PageSpeed Audit Brief Template
...
Use this template when a separate reusable reference is useful, such as when another skill needs the normalized intake structure without re-reading the full workflow.
