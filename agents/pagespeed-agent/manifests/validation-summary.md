...
- Agent files discovered: 27
- Agent files exported: 27
- Skills discovered: 25
- Skills listed in Markdown manifest: 25
- Skills listed in CSV manifest: 25
- MCP resource registry entries discovered: 0
- MCP resource template entries discovered: 0
- Missing copied files: 0
- Empty files found in export: 0
- Duplicate file-content groups found: 8

## Skill Folder Count Comparison

| Skill | Original readable files | Exported files | Status |
| --- | ---: | ---: | --- |
| Presentations | 112 | 112 | match |
| Spreadsheets | 12 | 12 | match |
| audit-qa-validator | 3 | 3 | match |
| client-site-context-manager | 4 | 4 | match |
| documents | 76 | 76 | match |
| drive-report-organizer | 3 | 3 | match |
...
| pagespeed-audit-comparison | 3 | 3 | match |
| pagespeed-audit-onboarding | 4 | 4 | match |
| pagespeed-audit-prioritizer | 3 | 3 | match |
| pagespeed-audit-report-writer | 4 | 4 | match |
| pagespeed-intake-normalizer | 4 | 4 | match |
| pagespeed-skill-router | 3 | 3 | match |
| pdf | 3 | 3 | match |
| plugin-creator | 10 | 10 | match |
| skill-creator | 9 | 9 | match |
| skill-installer | 8 | 8 | match |
| wordpress-pagespeed-diagnosis | 3 | 3 | match |

## Duplicate Content Groups

- skills/agent-attached/hermes/client-site-context-manager/assets/icon.svg; skills/agent-attached/hermes/drive-report-organizer/assets/icon.svg
- skills/agent-attached/hermes/pagespeed-skill-router/assets/icon.svg; skills/agent-attached/hermes/pagespeed-intake-normalizer/assets/icon.svg; skills/agent-attached/hermes/wordpress-pagespeed-diagnosis/assets/icon.svg; skills/agent-attached/hermes/pagespeed-audit-onboarding/assets/icon.svg; skills/agent-attached/hermes/pagespeed-audit-prioritizer/assets/icon.svg; skills/agent-attached/hermes/pagespeed-audit-comparison/assets/icon.svg
- skills/platform-managed/system/skill-creator/license.txt; skills/platform-managed/system/skill-installer/LICENSE.txt
- skills/platform-managed/system/imagegen/LICENSE.txt; skills/platform-managed/system/openai-docs/LICENSE.txt
- skills/platform-managed/system/skill-creator/assets/skill-creator-small.svg; skills/platform-managed/system/plugin-creator/assets/plugin-creator-small.svg
