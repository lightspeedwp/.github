...
- Downloadable PDFs present
- Target platform is WordPress
- Rebuild goals: cleaner design, easier editing, improved performance
- No ecommerce
- No booking flow
- Multilingual not in scope
...
- Migration volume for blog posts, team profiles, PDFs, and redirects
- Staging availability
- Analytics and SEO baseline requirements
