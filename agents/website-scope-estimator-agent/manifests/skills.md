...
| ----- | ----------- | ----------- | ------------------- | ---------------- | ------------- | ----- |
| Presentations | directory-installed | /root/.codex/skills/builtins/presentations | yes | yes | fully exported | 112 files exported |
| Spreadsheets | directory-installed | /root/.codex/skills/builtins/spreadsheets | yes | yes | fully exported | 12 files exported |
| documents | directory-installed | /root/.codex/skills/builtins/documents | yes | yes | fully exported | 76 files exported |
| estimator-onboarding | agent-attached | /root/.codex/skills/hermes/estimator-onboarding | yes | yes | fully exported | 3 files exported |
| figma-code-connect | plugin-provided | /root/.codex/plugins/cache/openai-marketplace/figma/local/skills/figma-code-connect | yes | yes | fully exported | 3 files exported |
| figma-create-new-file | plugin-provided | /root/.codex/plugins/cache/openai-marketplace/figma/local/skills/figma-create-new-file | yes | yes | fully exported | 1 files exported |
| figma-generate-design | plugin-provided | /root/.codex/plugins/cache/openai-marketplace/figma/local/skills/figma-generate-design | yes | yes | fully exported | 3 files exported |
| figma-generate-diagram | plugin-provided | /root/.codex/plugins/cache/openai-marketplace/figma/local/skills/figma-generate-diagram | yes | yes | fully exported | 8 files exported |
| figma-generate-library | plugin-provided | /root/.codex/plugins/cache/openai-marketplace/figma/local/skills/figma-generate-library | yes | yes | fully exported | 17 files exported |
| figma-implement-motion | plugin-provided | /root/.codex/plugins/cache/openai-marketplace/figma/local/skills/figma-implement-motion | yes | yes | fully exported | 7 files exported |
| figma-swiftui | plugin-provided | /root/.codex/plugins/cache/openai-marketplace/figma/local/skills/figma-swiftui | yes | yes | fully exported | 3 files exported |
| figma-use | plugin-provided | /root/.codex/plugins/cache/openai-marketplace/figma/local/skills/figma-use | yes | yes | fully exported | 21 files exported |
| figma-use-figjam | plugin-provided | /root/.codex/plugins/cache/openai-marketplace/figma/local/skills/figma-use-figjam | yes | yes | fully exported | 14 files exported |
| figma-use-motion | plugin-provided | /root/.codex/plugins/cache/openai-marketplace/figma/local/skills/figma-use-motion | yes | yes | fully exported | 3 files exported |
| figma-use-slides | plugin-provided | /root/.codex/plugins/cache/openai-marketplace/figma/local/skills/figma-use-slides | yes | yes | fully exported | 7 files exported |
| frontend-skill | local | /root/.codex/skills/frontend-skill | yes | yes | fully exported | 2 files exported |
| gh-address-comments | plugin-provided | /root/.codex/plugins/cache/openai-marketplace/github/local/skills/gh-address-comments | yes | yes | fully exported | 6 files exported |
| gh-fix-ci | plugin-provided | /root/.codex/plugins/cache/openai-marketplace/github/local/skills/gh-fix-ci | yes | yes | fully exported | 6 files exported |
| github | plugin-provided | /root/.codex/plugins/cache/openai-marketplace/github/local/skills/github | yes | yes | fully exported | 4 files exported |
| gmail | plugin-provided | /root/.codex/plugins/cache/openai-marketplace/gmail/local/skills/gmail | yes | yes | fully exported | 12 files exported |
| gmail-inbox-triage | plugin-provided | /root/.codex/plugins/cache/openai-marketplace/gmail/local/skills/gmail-inbox-triage | yes | yes | fully exported | 4 files exported |
| google-calendar | plugin-provided | /root/.codex/plugins/cache/openai-marketplace/google-calendar/local/skills/google-calendar | yes | yes | fully exported | 4 files exported |
| google-calendar-daily-brief | plugin-provided | /root/.codex/plugins/cache/openai-marketplace/google-calendar/local/skills/google-calendar-daily-brief | yes | yes | fully exported | 5 files exported |
| google-calendar-free-up-time | plugin-provided | /root/.codex/plugins/cache/openai-marketplace/google-calendar/local/skills/google-calendar-free-up-time | yes | yes | fully exported | 4 files exported |
| google-calendar-group-scheduler | plugin-provided | /root/.codex/plugins/cache/openai-marketplace/google-calendar/local/skills/google-calendar-group-scheduler | yes | yes | fully exported | 4 files exported |
| google-calendar-meeting-prep | plugin-provided | /root/.codex/plugins/cache/openai-marketplace/google-calendar/local/skills/google-calendar-meeting-prep | yes | yes | fully exported | 4 files exported |
| google-docs | plugin-provided | /root/.codex/plugins/cache/openai-marketplace/google-drive/local/skills/google-docs | yes | yes | fully exported | 19 files exported |
| google-drive | plugin-provided | /root/.codex/plugins/cache/openai-marketplace/google-drive/local/skills/google-drive | yes | yes | fully exported | 10 files exported |
| google-drive-comments | plugin-provided | /root/.codex/plugins/cache/openai-marketplace/google-drive/local/skills/google-drive-comments | yes | yes | fully exported | 2 files exported |
| google-sheets | plugin-provided | /root/.codex/plugins/cache/openai-marketplace/google-drive/local/skills/google-sheets | yes | yes | fully exported | 11 files exported |
| google-slides | plugin-provided | /root/.codex/plugins/cache/openai-marketplace/google-drive/local/skills/google-slides | yes | yes | fully exported | 19 files exported |
| imagegen | platform-managed | /root/.codex/skills/.system/imagegen | yes | yes | fully exported | 12 files exported |
| linear | plugin-provided | /root/.codex/plugins/cache/openai-marketplace/linear/local/skills/linear | yes | yes | fully exported | 5 files exported |
...
| quote-readiness | agent-attached | /root/.codex/skills/hermes/quote-readiness | yes | yes | fully exported | 2 files exported |
...
| slack | plugin-provided | /root/.codex/plugins/cache/openai-marketplace/slack/local/skills/slack | yes | yes | fully exported | 5 files exported |
| slack-channel-summarization | plugin-provided | /root/.codex/plugins/cache/openai-marketplace/slack/local/skills/slack-channel-summarization | yes | yes | fully exported | 4 files exported |
| slack-daily-digest | plugin-provided | /root/.codex/plugins/cache/openai-marketplace/slack/local/skills/slack-daily-digest | yes | yes | fully exported | 4 files exported |
| slack-notification-triage | plugin-provided | /root/.codex/plugins/cache/openai-marketplace/slack/local/skills/slack-notification-triage | yes | yes | fully exported | 4 files exported |
| slack-outgoing-message | plugin-provided | /root/.codex/plugins/cache/openai-marketplace/slack/local/skills/slack-outgoing-message | yes | yes | fully exported | 4 files exported |
| slack-reply-drafting | plugin-provided | /root/.codex/plugins/cache/openai-marketplace/slack/local/skills/slack-reply-drafting | yes | yes | fully exported | 4 files exported |
| website-evidence-pass | agent-attached | /root/.codex/skills/hermes/website-evidence-pass | yes | yes | fully exported | 2 files exported |
| website-intake-workflow | agent-attached | /root/.codex/skills/hermes/website-intake-workflow | yes | yes | fully exported | 3 files exported |
| website-package-routing | agent-attached | /root/.codex/skills/hermes/website-package-routing | yes | yes | fully exported | 2 files exported |
| yeet | plugin-provided | /root/.codex/plugins/cache/openai-marketplace/github/local/skills/yeet | yes | yes | fully exported | 5 files exported |
