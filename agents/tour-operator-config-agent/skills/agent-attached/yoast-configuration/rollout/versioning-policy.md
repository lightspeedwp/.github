...
Use simple semantic versioning for the skill package.

- Patch: wording, template, typo, or non-behavioural reference update.
- Minor: new profile, template, intake, reference section, validation script, or scenario test.
