...
- Created a tour-operator-focused version from the original Yoast audit structure.
- Removed travel-irrelevant commerce files, routing, templates, scenarios and references.
