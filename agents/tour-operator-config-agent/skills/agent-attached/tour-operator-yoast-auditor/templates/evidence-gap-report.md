# Yoast Evidence Gap Report: [Site or Scope]
...
## Summary
[Explain what cannot be confirmed yet and why.]
...
## Blocked checks
| Check | Missing evidence | Why it matters | Minimum evidence needed | Owner / next route |
|---|---|---|---|---|

## Safe next step
[One practical next step to unblock the audit.]
