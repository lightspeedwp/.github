# Taxonomy and Archive Review: [Site or Scope]
...
| Archive URL | Archive type | Indexation intent | Canonical | Meta robots | Sitemap status | Content quality note | Priority | Recommendation | Owner / next route | Retest |
|---|---|---|---|---|---|---|---|---|---|---|

## Archive types to consider
