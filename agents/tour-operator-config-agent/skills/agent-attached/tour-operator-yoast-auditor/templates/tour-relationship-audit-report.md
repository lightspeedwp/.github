# Tour Relationship Audit Report: [Site or Scope]
...
[Summarise whether tours, destinations, accommodation, travel styles, specials, reviews and enquiry paths are represented clearly enough for users and search engines.]
...
- Reviewed travel styles:
- Reviewed enquiry paths:
- Evidence source:
- Exclusions:

## Relationship findings

| Priority | Finding | Affected content | Evidence status | Confidence | Risk | Recommendation | Owner / next route | Retest |
|---|---|---|---|---|---|---|---|---|

## Relationship coverage

| Relationship | Observed? | Evidence | Risk | Next action |
|---|---|---|---|---|
| Tours to destinations |  |  |  |  |
| Tours to accommodation |  |  |  |  |
| Tours to itineraries |  |  |  |  |
| Tours to travel styles |  |  |  |  |
| Specials to related travel content |  |  |  |  |
| Reviews to relevant pages |  |  |  |  |
| Enquiry paths from important pages |  |  |  |  |
