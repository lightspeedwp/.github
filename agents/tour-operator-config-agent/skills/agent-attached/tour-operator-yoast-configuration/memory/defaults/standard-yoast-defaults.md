...
Use these only as starting assumptions when no site-specific evidence exists.

- Keep high-value public pages indexable.
- Review archives before broad exclusion.
