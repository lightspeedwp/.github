...
Use this index when the request is broad, mixed or unclear. Load only the files needed for the current task.

| Request type | Load first | Then load if needed |
|---|---|---|
| Tour operator structure | `references/tour-operator-seo-playbook.md` | `profiles/tour-operator-website.md`, `intake/tour-operator-intake.md` |
| General Yoast settings | `references/configuration-reference.md` | `references/qa-checklists.md` |
| Taxonomy or archives | `references/content-structure-taxonomy-playbook.md` | `references/taxonomy-indexation-decision-model.md`, `templates/taxonomy-indexation-decision-pack.md` |
| Rendered-output QA | `references/rendered-output-qa-playbook.md` | `templates/rendered-output-qa-report.md` |
| Redirect or migration | `references/redirect-migration-governance.md` | `references/redirect-map-decision-model.md`, `templates/redirect-map-review.md` |
| Multilingual | `references/multilingual-hreflang-playbook.md` | `references/locale-metadata-governance.md`, `templates/multilingual-seo-qa-report.md` |
| AI metadata | `references/ai-assisted-seo-workflow.md` | `references/ai-metadata-review-model.md`, `templates/ai-metadata-approval-pack.md` |
| Bulk metadata | `references/bulk-metadata-governance.md` | `references/approval-queue-workflow.md`, `templates/metadata-bulk-edit-plan.md` |
| Live admin action | `references/related-skills-routing.md` | `templates/wordpress-admin-change-plan.md` |
