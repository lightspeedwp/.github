# Tour Operator Gravity Forms Auditor -> Configuration Contract
...
Use this contract when `tour-operator-gravity-forms-auditor` identifies actionable Gravity Forms findings that require approved remediation by `tour-operator-gravity-forms-configuration`.
...
| `target_skill` | Yes | Usually `tour-operator-gravity-forms-configuration`. |
