...
- Stock, tax, recurring billing, fulfilment, and payment flow assumptions are not made.

### Tour operator enquiry

- Single traveller and group enquiry paths.
- Flexible dates and fixed date paths.
- Destination/interests conditional questions.
