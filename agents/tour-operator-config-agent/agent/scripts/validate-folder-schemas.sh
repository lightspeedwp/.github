...
if [[ -d templates ]]; then
  ...
  skip "templates/ is not present in the current attached file tree"
fi
...
if [[ -d examples ]]; then
  ...
  for file in examples/*.md; do
    ...
    case "$(basename "$file")" in
      ...
      example-tour-operator-plugin-audit.md)
        require_heading "$file" '## Core plugin findings'
        require_heading "$file" '## Extension plugin findings'
        require_heading "$file" '## Gravity Forms findings'
        require_heading "$file" '## Yoast findings'
        require_heading "$file" '## General WordPress findings'
        ;;
      ...
      example-yoast-seo-audit.md)
        require_heading "$file" '## Search appearance'
        require_heading "$file" '## Sitemaps'
        require_heading "$file" '## Breadcrumbs and schema'
        require_heading "$file" '## Priority follow-ups'
        ;;
      *)
  ...
  skip "examples/ is not present in the current attached file tree"
fi
...
if [[ -d memory ]]; then
  ...
  skip "memory/ is not present in the current attached file tree"
fi
