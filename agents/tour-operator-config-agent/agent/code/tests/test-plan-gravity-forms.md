...
3. Newsletter signup
4. Spam-prevention check
5. Confirmation-message review
6. Notification routing review
...
- Privacy and consent elements appear where required
- Anti-spam protection is active without blocking real users
