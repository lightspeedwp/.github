...
> Use this file to capture durable technical context for the project.
> Update it when repo details, integrations, tooling, environment notes, or technical constraints are added or changed.
> Keep it grounded in confirmed facts and clearly labelled assumptions.
