...
> Use this file to capture durable product, user, and business context.
> Update it when the run clarifies user needs, business goals, success measures, or important editorial context.
> Keep it focused on what should shape planning decisions across future runs.
