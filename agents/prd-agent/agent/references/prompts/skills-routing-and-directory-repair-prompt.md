...
Use this prompt after running the skills-routing and directory validation prompt and collecting a concrete issue list. This is the matching repair pass for the issues that validation found.
...
4. repair broken or weak cross-links between routing docs, inventory docs, parity docs, validation prompts, cleanup prompts, and manual-resolution guidance
5. repair cases where documented specialist boundaries are misleading, duplicated, or inconsistent with the actual attached skill roles
...
- update examples, fixtures, or validation notes only when their current wording would mislead future audits or rebuild work
...
- do not collapse the distinction between attached skills, local drafts, prompts, references, rollout docs, templates, examples, fixtures, memory defaults, and memory schemas
- do not widen scope into unrelated redesign work unless a validated inconsistency requires it
...
- after repairing, summarize exactly:
  - what was repaired
