...
| Field | Value | Status | Source | Save policy | Notes |
|---|---|---|---|---|---|
| Project or task type |  | missing |  | confirm_before_save |  |
| Primary goal |  | missing |  | save_if_user_confirms |  |
| Audience |  | missing |  | confirm_before_save |  |
| Workflow context |  | inferred |  | current_run_only |  |
| Questionnaire source |  | inferred |  | current_run_only |  |
| Reference assets |  | missing |  | save_links_only |  |
| Output format |  | defaulted |  | current_run_only |  |
