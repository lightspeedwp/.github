...
| Item | Status | Save Policy | Reason |
|---|---|---|---|
|  |  |  |  |

## Notes

- Do not save inferred or defaulted questionnaire values without confirmation.
- Prefer links, identifiers, and confirmed decisions over copied source text.
