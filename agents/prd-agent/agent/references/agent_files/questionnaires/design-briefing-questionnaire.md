...
**Answer:** Upload SVG, AI, EPS or highest-resolution PNG available.
...
**Answer:** Readable web fonts; confirm if brand fonts are licensed for web use.
...
**Answer:** Use readable contrast, clear focus states, keyboard-friendly interactions and descriptive alt text.
