...
1. A release plan should produce acceptance coverage and launch checks.
2. Accessibility and tracking coverage should stay visible when relevant.
3. Actual findings should be routed to triage, not handled as planned QA.
