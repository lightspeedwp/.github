...
1. Missing evidence should not become claimed progress.
2. Client-safe output should avoid internal-only detail unless requested.
3. Status updates should flag when change or QA follow-up is needed.
