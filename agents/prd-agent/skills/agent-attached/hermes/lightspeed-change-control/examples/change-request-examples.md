...
- Mid-project stakeholder request that adds a new onboarding path
- QA-driven change that expands regression scope
- Technical blocker that forces dependency replacement
