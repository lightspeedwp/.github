...
| Source | Type | URL/file | Owner | Status | Confidence | Use in PRD? | Use in tasks? | Notes |
|---|---|---|---|---|---|---:|---:|---|
| Client brief | Brief |  |  | Missing |  |  |  |  |
| Figma design system | Figma |  |  | Missing |  |  |  |  |
| Figma prototype | Figma |  |  | Missing |  |  |  |  |
| Theme repo | GitHub |  |  | Missing |  |  |  |  |
| Block plugin repo | GitHub |  |  | Missing |  |  |  |  |
| Live site | Website |  |  | Missing |  |  |  |  |
| Staging/dev site | Website |  |  | Missing |  |  |  |  |
