...
Use this template for daily or weekday operational digests.

## Overall backlog picture

- [Current open or updated picture]
- [Main risk]
- [Main support action]

## Needs attention today

| Ticket or segment | Why now | Evidence | Action |
|---|---|---|---|
...
| Ticket | Signal | Owner/group | Action |
|---|---|---|---|
...
## Repeat themes or incident signals

| Theme | Classification | Evidence | Action |
|---|---|---|---|
