...
Use this template for period-over-period backlog or support trend analysis.

## Trend summary

- [Most material increase/decrease]
- [Main unresolved risk]
- [Best immediate support action]
...
| Theme | Current evidence | Comparison evidence | Classification | Action |
|---|---|---|---|---|
...
- [Unavailable or unchecked signal]
