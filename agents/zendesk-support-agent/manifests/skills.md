...
| zendesk-backlog-trend-analysis | agent-attached | /root/.codex/skills/hermes/zendesk-backlog-trend-analysis | yes | yes | fully exported | 55 files exported |
| zendesk-bug-report-package | agent-attached | /root/.codex/skills/hermes/zendesk-bug-report-package | yes | yes | fully exported | 15 files exported |
| zendesk-case-readiness-check | agent-attached | /root/.codex/skills/hermes/zendesk-case-readiness-check | yes | yes | fully exported | 14 files exported |
| zendesk-create-knowledge | agent-attached | /root/.codex/skills/hermes/zendesk-create-knowledge | yes | yes | fully exported | 11 files exported |
| zendesk-customer-escalation | agent-attached | /root/.codex/skills/hermes/zendesk-customer-escalation | yes | yes | fully exported | 10 files exported |
| zendesk-customer-research | agent-attached | /root/.codex/skills/hermes/zendesk-customer-research | yes | yes | fully exported | 11 files exported |
| zendesk-draft-response | agent-attached | /root/.codex/skills/hermes/zendesk-draft-response | yes | yes | fully exported | 34 files exported |
| zendesk-duplicate-pattern-review | agent-attached | /root/.codex/skills/hermes/zendesk-duplicate-pattern-review | yes | yes | fully exported | 9 files exported |
| zendesk-evidence-collector | agent-attached | /root/.codex/skills/hermes/zendesk-evidence-collector | yes | yes | fully exported | 16 files exported |
| zendesk-evidence-quality-review | agent-attached | /root/.codex/skills/hermes/zendesk-evidence-quality-review | yes | yes | fully exported | 33 files exported |
| zendesk-handoff-prep | agent-attached | /root/.codex/skills/hermes/zendesk-handoff-prep | yes | yes | fully exported | 15 files exported |
| zendesk-help-center-grounding | agent-attached | /root/.codex/skills/hermes/zendesk-help-center-grounding | yes | yes | fully exported | 10 files exported |
| zendesk-knowledge-candidate-review | agent-attached | /root/.codex/skills/hermes/zendesk-knowledge-candidate-review | yes | yes | fully exported | 8 files exported |
| zendesk-refund-assessment | agent-attached | /root/.codex/skills/hermes/zendesk-refund-assessment | yes | yes | fully exported | 23 files exported |
| zendesk-router-skill | agent-attached | /root/.codex/skills/hermes/zendesk-router-skill | yes | yes | fully exported | 16 files exported |
| zendesk-ticket-triage | agent-attached | /root/.codex/skills/hermes/zendesk-ticket-triage | yes | yes | fully exported | 21 files exported |
| zendesk-triage-router | agent-attached | /root/.codex/skills/hermes/zendesk-triage-router | yes | yes | fully exported | 23 files exported |
