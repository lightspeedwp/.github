...
describe("ADR CLI Commands", () => {
  ...
  describe("supersede command", () => {
    ...
    test("should return input error when paths missing", async () => {
      const result = await executeSupersede({ positional: ["path1"] }, {});
    ...
    test("should prevent circular references", async () => {
      ...
      const result = await executeSupersede({ positional: [path1, path2] }, {});
  ...
  describe("link command", () => {
    ...
    test("should return input error when paths missing", async () => {
      const result = await executeLink({ positional: ["path1"] }, {});
