...
Use these templates to adapt proposal framing, priorities, proof points, and draft structure to the buyer audience. Apply the closest-fit template before drafting substantive proposal content. If more than one audience fits, combine the most relevant priorities and state that blended assumption.
...
- Overly generic statements about scale or reliability
...
- Design systems for repeatable publishing patterns
...
- Strong performance on content-heavy pages
...
- Unsupported claims about newsroom scale or audience growth
...
- Content-management workflow for products and campaigns
...
- Integration clarity across commerce, CRM, or fulfillment tools
...
- Weak detail on performance, mobile UX, or optimization support
...
- Billing or subscription integration considerations
- Editorial/operations workflow for ongoing member value
...
- Better operational visibility and maintainability
...
- Weak detail on ongoing operational workflows and support
...
- Booking system or operational integration considerations
- Mobile experience, performance, and accessibility
...
- Clear integration thinking around bookings and operations
...
- Unclear mobile or performance strategy for high-intent users

## Template Selection Rules

- First identify the likely buyer audience from the request artifact, brief, or user instruction.
- If the audience is explicit, use that template directly.
- If the audience is implicit, infer the best fit from the organization's business model, site type, proposal language, and stated priorities.
- If two audiences overlap, choose a primary template and blend only the sections and priorities that materially improve the draft.
- State the chosen audience template in the intake summary when it affects framing.
- If the audience is uncertain, name the most likely template and mark it as an assumption.
