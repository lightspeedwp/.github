...
Use this file as the canonical business-context source for reusable agency positioning, package defaults, review expectations, and claim boundaries.
...
- default owner routing or review assumptions
- approved claim boundaries and risk defaults
...
- design-to-code workflows tied to defined design systems
- accessible, high-performing code aligned to brand guidelines
- AI governance as an important prerequisite for content and implementation quality
- a service architecture grouped into Foundation, Growth, and Enterprise tiers
...
- stronger expectations around performance, accessibility, governance, and maintainability
...
- strong delivery-management, risk-management, and quality-assurance expectations
...
- legal -> legal reviewer, leadership, or the person responsible for contractual sign-off
- security -> security reviewer, technical lead, or engineering lead when a named security owner is not available
...
- legal review should confirm contractual language, liability-sensitive wording, commitments, exceptions, and any terms that should not be treated as approved by default
- security review should confirm security posture statements, architecture-sensitive claims, privacy or data-handling language, and any control descriptions that need specialist validation
...
- route margin-sensitive or unusually structured commercials to pricing or leadership review
...
- the agency can describe AI governance and AI-supported workflows as emerging or important capabilities when that framing stays conservative and evidence-based
...
- legal, privacy, security, accessibility, or compliance commitments phrased as guarantees
- customer counts, named clients, testimonials, or reference availability
- claims that every engagement includes AI workflows, design systems, enterprise architecture, or advanced integrations
...
- promises that AI is fully embedded across all services
