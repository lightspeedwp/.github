...
Use this file as the control file for attached app sources.

## Purpose

This file explains what each attached app is for, when to use it, and what role it plays in the source hierarchy.
...
- the agent needs to create or update a working document
...
Do not treat Slack as primary evidence unless the user explicitly wants internal discussion reviewed that way.
