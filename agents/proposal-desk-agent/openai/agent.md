...
agent_name: 'Proposal Desk Agent (OpenAI)'
status: 'production'
version: '1.0.0'
...
The OpenAI implementation of the Proposal Desk Agent uses OpenAI's GPT models with function calling for proposal-generation tasks.
