...
- PASS: Every copied file exists in export (0 missing)
- PASS: Exported local skill folder listings match originals (all matched)
- PASS: Every visible skill appears in skills.md and skills.csv (csv=42, expected=42, missing_md=[])
- PASS: Metadata-only skills are not represented as full exports (ok)
- PASS: Empty files identified (0 empty files)
- PASS: Duplicate files identified by checksum (13 duplicate checksum groups)
...
- skills/agent-attached/linear-sub-issue-splitter/assets/icon.svg; skills/agent-attached/linear-triage-sop-builder/assets/icon.svg; skills/agent-attached/linear-the-architect/assets/icon.svg; skills/agent-attached/linear-decision-logger/assets/icon.svg; skills/agent-attached/linear-app-skill-creator/assets/icon.svg; skills/agent-attached/linear-triage-router/assets/icon.svg; skills/agent-attached/linear-skill-intake-onboarding/assets/icon.svg; skills/agent-attached/linear-memory-maintenance/assets/icon.svg
- skills/agent-attached/linear-project-pulse/assets/icon.svg; skills/agent-attached/linear-voice-of-customer/assets/icon.svg; skills/agent-attached/linear-unplanned-work-intake-audit/assets/icon.svg; skills/agent-attached/linear-momentum-auditor/assets/icon.svg; skills/agent-attached/linear-duplicate-management-playbook/assets/icon.svg; skills/agent-attached/linear-triage-rules-designer/assets/icon.svg
- skills/local/imagegen/LICENSE.txt; skills/local/openai-docs/LICENSE.txt; skills/plugin-provided/github__gh-fix-ci/LICENSE.txt; skills/plugin-provided/github__yeet/LICENSE.txt
- skills/local/skill-creator/license.txt; skills/local/skill-installer/LICENSE.txt
- skills/local/plugin-creator/assets/plugin-creator-small.svg; skills/local/skill-creator/assets/skill-creator-small.svg
- skills/local/plugin-creator/assets/plugin-creator.png; skills/local/skill-creator/assets/skill-creator.png
- skills/plugin-provided/linear__linear/LICENSE.txt; skills/plugin-provided/github__gh-address-comments/LICENSE.txt
- skills/plugin-provided/slack__slack-daily-digest/assets/slack.png; skills/plugin-provided/slack__slack/assets/slack.png; skills/plugin-provided/slack__slack-reply-drafting/assets/slack.png; skills/plugin-provided/slack__slack-notification-triage/assets/slack.png; skills/plugin-provided/slack__slack-channel-summarization/assets/slack.png; skills/plugin-provided/slack__slack-outgoing-message/assets/slack.png
- skills/plugin-provided/slack__slack-daily-digest/assets/slack-small.svg; skills/plugin-provided/slack__slack/assets/slack-small.svg; skills/plugin-provided/slack__slack-reply-drafting/assets/slack-small.svg; skills/plugin-provided/slack__slack-notification-triage/assets/slack-small.svg; skills/plugin-provided/slack__slack-channel-summarization/assets/slack-small.svg; skills/plugin-provided/slack__slack-outgoing-message/assets/slack-small.svg
- skills/plugin-provided/github__github/assets/github.png; skills/plugin-provided/github__gh-fix-ci/assets/github.png; skills/plugin-provided/github__gh-address-comments/assets/github.png
