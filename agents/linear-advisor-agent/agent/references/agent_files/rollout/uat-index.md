...
- [Blank Memory UAT Scorecard](memory-uat-scorecard.md)
- [Filled Memory UAT Scorecard Example](memory-uat-scorecard-example.md)

## Rollout Docs

- [Focused UAT Plan](focused-uat-plan.md)
- [Team Onboarding Guide](team-onboarding-guide.md)
- [Teammate Rollout Checklist](teammate-rollout-checklist.md)
- [Skill Directory Audit](skill-directory-audit.md)
- [Rollout Index TSV](rollout-index.tsv)

## Related Guides

- [LightSpeed Agent Pilot Testing Guide](../lightspeed-agent-pilot-testing-guide.md)

## Suggested Order

1. Review the focused UAT plan
2. Use the teammate rollout checklist to confirm current setup assumptions
3. Use the blank scorecard during Memory testing
4. Compare against the filled example if needed
5. Use the onboarding guide for teammate rollout
6. Reference the skill audit and TSV index during verification
