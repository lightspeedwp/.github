...
> See the organisation-wide [Automation Governance & Release Strategy](https://github.com/lightspeedwp/.github/blob/develop/docs/AUTOMATION.md) for contributor rules.
