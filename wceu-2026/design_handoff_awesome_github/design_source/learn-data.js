...
/* ──────────────────────────────────────────────────────────────────
   ...
   window.LSCONTENT) — rendered faithfully. Only the scaffolding here
   (track intros, "what you'll learn" lines, ordering) is authored.
   ────────────────────────────────────────────────────────────────── */

/* Each lesson: doc = key into LSCONTENT.docs; src = real repo path for the
...
window.LSLEARN = { LEARN_TRACKS, COOKBOOK_RECIPES, readingTime };
