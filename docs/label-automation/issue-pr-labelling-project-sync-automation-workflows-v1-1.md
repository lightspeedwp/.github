...
*Updated 17 Oct 2025: supports new BugHerd families. `status:_`rules unchanged (exactly one). Extend`actions/labeler`patterns to emit`type:_`, `block:_`, `template:_`, `woo:_`, `to:_`, etc.*
