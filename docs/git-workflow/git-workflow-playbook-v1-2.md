...
[B) CODE_OF_CONDUCT.md (ideal description & structure)](<#b)-code_of_conduct.md-(ideal-description-&-structure)>)
...
- GitHub/docs examples — Code of Conduct: [https://github.com/github/docs/blob/main/.github/CODE_OF_CONDUCT.md](https://github.com/github/docs/blob/main/.github/CODE_OF_CONDUCT.md)
...
- Publish CONTRIBUTING.md and CODE_OF_CONDUCT.md.
