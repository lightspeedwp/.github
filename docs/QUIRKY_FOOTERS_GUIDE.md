...
- **Schema Validation**: `schema/quirky-footers.schema.json`
...
3. **Validate against schema**:
   ...
   ```bash
   npx ajv validate -s schema/quirky-footers.schema.json -d config/quirky-footers.yaml
   ```
...
- Validate against schema: `npx ajv validate -s schema/quirky-footers.schema.json -d config/quirky-footers.yaml`
...
- [Footer Validation Schema](../schema/quirky-footers.schema.json) — Configuration validation
