...
author: "LightSpeed"
maintainer: "Ash Shaw"
description: "Prompt template for Deep Research."
...
- Reference: `./deep-research-instructions.md`
...
- “Use `./deep-research-instructions.md`. My goal is […]. Inputs are […]. Produce […]. Show your plan then proceed.”
