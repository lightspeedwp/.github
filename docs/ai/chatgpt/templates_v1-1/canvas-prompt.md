...
title: "Canvas — Prompt Template"
version: "v1.0"
last_updated: "2025-10-17"
author: "LightSpeed"
maintainer: "Ash Shaw"
description: "Prompt template for Canvas."
...
- Reference: `./canvas-instructions.md`
...
- “Use `./canvas-instructions.md`. My goal is […]. Inputs are […]. Produce […]. Show your plan then proceed.”
