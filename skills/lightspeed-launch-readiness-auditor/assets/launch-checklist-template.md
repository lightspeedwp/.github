...
|---|---|---|---|---|
| Content | Priority pages approved | Pending |  |  |
| Links | Navigation and footer links tested | Pending |  |  |
| Redirects | Redirect map tested | Pending |  |  |
| Forms | Lead forms tested | Pending |  |  |
| Analytics | GA4/GTM events tested | Pending |  |  |
| Accessibility | Keyboard and contrast tested | Pending |  |  |
| Performance | Lighthouse/PageSpeed reviewed | Pending |  |  |
