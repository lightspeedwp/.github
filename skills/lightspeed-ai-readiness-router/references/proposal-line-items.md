...
Use these line items when turning AI readiness outputs into proposal notes.
...
| AI Content Policy | Lightweight policy for internal content teams. | Policy document. |
