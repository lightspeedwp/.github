...
| Item | Status | Owner | Evidence/source | Notes |
|---|---|---|---|---|
| Scope confirmed | Pending Review |  |  |  |
| Required approvers named | Pending Review |  |  |  |
| Source documents reviewed | Pending Review |  |  |  |
| Risks documented | Pending Review |  |  |  |
| Open decisions listed | Pending Review |  |  |  |
