...
| Page | Purpose | Key metrics | Notes |
|---|---|---|---|
| Executive overview |  | users, conversions, leads |  |
| Lead generation |  | form submissions, CTA clicks |  |
| Lead magnets |  | downloads, conversion rate |  |
