...
1. **Fade: 2-frame pop-in at 10fps** — 50% → 100% opacity (0.2s total). Easing curves look bad at low FPS
2. **Type → pause → annotate** — during fast action, show NO annotation. Pause, then add it
3. **Variable frame duration** — fast during action (100ms), slow during pauses (600-800ms), long hold for hero (500ms)
4. **Higher FPS for smooth motion** — 10fps minimum for typing/interaction
