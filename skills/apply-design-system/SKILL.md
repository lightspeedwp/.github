...
description: This skill helps you integrate an existing Figma design with a published design system, ensuring consistency and efficiency by replacing detached layers or local components with standardized elements. Use it when you want a broad review of the design's compliance or when you already know specific sections that need to be updated to the design system.
---
