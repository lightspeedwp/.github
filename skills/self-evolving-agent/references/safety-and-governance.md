...
Do not claim a mutation improves accuracy, reliability, latency, safety, or quality by a measured amount unless the result comes from a repeatable evaluation with named inputs.

Safe wording:

- “Expected to improve trigger clarity because...”
- “Passed the supplied regression examples.”
- “Not benchmarked; confidence is based on checklist review.”

Unsafe wording:

- “This makes the agent 30% better” without a tested benchmark.
- “The agent has improved itself” without a human-approved change and archive record.
- “This is production-safe” without deployment-context validation.
