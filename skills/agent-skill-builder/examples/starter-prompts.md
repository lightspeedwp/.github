...
| --- | --- | --- |
| Create a minimal local skill for weekly support summaries. | Minimal skill creation | No memory or validators needed |
| Create a standard local skill for turning PRD notes into GitHub issue drafts. | Standard skill creation | References and templates useful |
