...
- **GitHub Label Audit** — Audited all 169 canonical labels and recorded two findings: `type:decision` had no issue type, and 12 protected labels were missing from the label list. Added label inventories and evidence. (#3362)
