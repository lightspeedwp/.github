...
- **PR Creation Agent ESLint 10 Migration** — Migrated the PR creation agent linting to ESLint 10 with the new flat config format and updated Node requirements. ([PR #3326](https://github.com/lightspeedwp/.github/pull/3326))
