...
- **Broken relative links in repo-restructuring project docs** — Corrected three links in ``projects/active/repo-restructuring-2026-07-25/`` that used ``../../`` instead of ``../../../``, and one that carried a stray ``http://`` scheme on a relative path. Fixes the ``lint-and-links`` job.
