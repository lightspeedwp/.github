...
- **ADR Agent Portability — OpenSpec Specification (Proposal & Design)** — Comprehensive formal specifications for ADR Agent Portability initiative using OpenSpec system. Proposal document (2,000+ words) defines problem statement, solution approach, scope, 4-tier architecture, success criteria, GitHub coordination, timeline, and risk mitigation. Design document (3,000+ words) details technical design principles, tier architecture, configuration schema with JSON specification, four template variants (standard/lightweight/security/infrastructure), six modular validation rules, skills architecture with >85% coverage targets, GitHub integration workflows, test strategy breakdown, and week-by-week Phase 1 implementation plan. Updated active project README and OPENSPEC.md with OpenSpec integration headers linking to formal specifications. Enables formal specification tracking with bidirectional linking between OpenSpec system and GitHub issues (#1828 epic, #1829–#1833 phase issues). ([PR #1826](https://github.com/lightspeedwp/.github/pull/1826), [OpenSpec](../.github/projects/active/openspec/changes/adr-agent-portability/), [#1828](https://github.com/lightspeedwp/.github/issues/1828))
