...
- **GitHub Checks API for Changelog Validation** — Changelog violations now appear as check run annotations in the PR checks tab with severity levels, replacing comment-only feedback. ([PR #3376](https://github.com/lightspeedwp/.github/pull/3376))
