...
- PRD Agent Phase 6: Validated 28 canonical skills, fixed workflow issues. See [PR #2868](https://github.com/lightspeedwp/.github/pull/2868).
...
- Milestone automation Phase 2 follow-up: CodeRabbit fixes with 13/28 complete (46%). See [PR #2640](https://github.com/lightspeedwp/.github/pull/2640).
...
- PR labeling enforcement: 5-phase planning hub with governance framework. See [PR #2549](https://github.com/lightspeedwp/.github/pull/2549).
...
- Changelog safety audit: 7-layer validation framework with CI/CD integration. See [PR #2379](https://github.com/lightspeedwp/.github/pull/2379).

- Resolved 13 Dependabot alerts and bumped action versions across 12 workflows to Node.js 24 compliance.

### Fixed

- Fixed ESLint configuration: Added missing globals to reduce errors from 1,908 to 47 across 31 files.

- Fixed yaml.load references and removed duplicate ESLint configuration comments.

- Fixed validate-pr-template workflow to trigger on push events for branch protection compliance.

- Fixed @actions/github v9 ESM import compatibility in agent scripts with dynamic imports.

- Fixed 6 workflow parse errors: GitHub Actions syntax validation and secret context issues.

- Fixed labeling-check job dependency declarations in labeling-governance workflow.

- Security: Fixed branch name injection vulnerabilities in branch-name-validation workflow.

- Added minimatch as explicit dependency for labeling and issue management workflows.

- Fixed project-meta-sync workflow by setting GH_REPO environment variable for gh CLI.
...
- Test suite refactoring: Eliminated 500+ lines of duplicate mocks. All 161 tests passing. See [PR #2456](https://github.com/lightspeedwp/.github/pull/2456).

- Fixed markdown linting to consume patterns from .markdownlintignore. See [Issue #2428](https://github.com/lightspeedwp/.github/issues/2428).

### Removed

- Consolidated issue-field-sync workflows into single project-field-sync with bulk/targeted modes. See [Issue #1408](https://github.com/lightspeedwp/.github/issues/1408).
- Label governance Phase 1: Removed defective labeling script and updated governance documentation. See [PR #2476](https://github.com/lightspeedwp/.github/pull/2476).
