...
- **Portable Prompt Engineer Agent — OpenSpec Specification Phase complete** — Comprehensive specification and planning documentation for converting the `.github`-specific Prompt Engineer Agent into a portable, reusable agent for LightSpeed organisation repositories. Phase 1 deliverables include: (1) Strategic planning documentation (QUESTIONS.md with 12 decision questions, ANSWERS.md with best practice answers and trade-offs, SCOPE.md with scope boundaries and success criteria); (2) OpenSpec formal specification with proposal.md (problem statement, capabilities, impact analysis) and design.md (7 key architectural decisions, risk analysis, four-phase migration plan); (3) GitHub issue tracking (#1805 Epic for all phases, #1804 PR for specification deliverables); (4) Reciprocal linking between GitHub issues and project documentation. Architecture decisions: single universal agent (not variants) with context-aware behavior for `.github`, WordPress plugins, and WordPress themes; root `agents/prompt-engineer/` primary location + `.github/agents/` mirror for backward compatibility; auto-detect context via repository markers; four-layer testing strategy (unit 80%+ coverage, integration, acceptance, repository-specific); semantic versioning with quarterly releases; distributed ownership model. Timeline: Phase 1 Specification complete, Phase 2 Core implementation (3–4 weeks), Phase 3 Testing & validation (2–3 weeks), Phase 4 Documentation & release (2 weeks). Total 9–12 weeks from specification to production. ([PR #1804](https://github.com/lightspeedwp/.github/pull/1804), [Issue #1805](https://github.com/lightspeedwp/.github/issues/1805), [Project](../.github/projects/active/portable-prompt-engineer-agent-spec-2026-08-12/))
