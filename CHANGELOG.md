...
- **Semantic-Version Release Branches** — The branch validator used by CI and the npm script now accepts documented release branch names such as `release/v1.2.3`, `release/1.2.3` and `release/v1.2.3-rc1`.
