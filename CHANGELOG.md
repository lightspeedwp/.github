...
- **Test Check on Every Pull Request** — Non-documentation pull requests now run the full test suite and fail only on failures they introduce; documentation-only pull requests report success without installing dependencies or running Jest. (#3479)
