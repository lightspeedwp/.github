...
- **Issue Types Aligned** — Issue types and type labels now follow the colour strategy and include descriptions. Decision replaces Question; questions move to Discussions. (#3530)
