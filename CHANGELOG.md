...
- **Stale Pull Requests Self-Update** — Pull requests labelled to stay current merge in the latest base branch automatically, so they stop going stale. ([#3476](https://github.com/lightspeedwp/.github/pull/3476))
