...
- **Remaining Dependabot Alerts** — Added Dependabot npm scanning for 4 previously-unscanned lockfiles; overrode transitive smol-toml and lodash-es to patched versions. ([PR TBD]())
