...
- **Portable Prompt Engineer Agent — OpenSpec Specification Phase complete** — Comprehensive specification and planning documentation for converting the `.github`-specific Prompt Engineer Agent into a portable, reusable agent for LightSpeed organisation repositories. Phase 1 deliverables include: (1) Strategic planning documentation (QUESTIONS.md, ANSWERS.md, SCOPE.md); (2) OpenSpec formal specification (proposal.md, design.md); (3) GitHub issue tracking (#1805 Epic, #1804 PR); (4) Reciprocal linking between issues and documentation. Architecture: single universal agent with context-aware behavior for `.github`, WordPress plugins, and themes; root `agents/prompt-engineer/` primary + `.github/agents/` mirror; auto-detect context via repository markers; four-layer testing (80%+ coverage); distributed ownership. Timeline: Phase 1 complete, Phases 2-4 over 9–12 weeks. ([PR #1804](https://github.com/lightspeedwp/.github/pull/1804), [Issue #1805](https://github.com/lightspeedwp/.github/issues/1805))
