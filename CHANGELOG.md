...
- **Comprehensive agent & skills standardisation documentation** — Added 9 canonical standards documents covering the full AI operations and agent lifecycle: `docs/AGENT_STANDARDS.md` (single-file and folder-based agent design patterns), `docs/SKILLS_STANDARDS.md` (shared skill creation and reusability), `docs/INSTRUCTIONS_STANDARDS.md` (instruction file creation guidelines), `docs/WORKFLOWS_STANDARDS.md` (agentic workflow patterns and Markdown format), `docs/COOKBOOKS_STANDARDS.md` (implementation guides and playbooks), `docs/PROMPTS_STANDARDS.md` (reusable prompt templates), `docs/PLUGINS_STANDARDS.md` (Claude Code plugin creation), `docs/HOOKS_STANDARDS.md` (event-driven automation hooks), and `docs/AI_REFERENCES_STANDARDS.md` (canonical AI model and runner references). Each document includes purpose, folder structure, file format specs, mandatory sections, real-world examples, Mermaid diagrams, and cross-references. Accompanied by `.github/projects/active/agent-skills-standards-comprehensive/` with detailed 2.0 expansion plan documenting 12 enhancement phases, Awesome Copilot audit findings, and Phase 2-3 roadmap. Created epic [#1261](https://github.com/lightspeedwp/.github/issues/1261) with child issues [#1262–#1270](https://github.com/lightspeedwp/.github/issues) tracking implementation. ([PR #1251](https://github.com/lightspeedwp/.github/pull/1251); [#1256](https://github.com/lightspeedwp/.github/issues/1256), [#1257](https://github.com/lightspeedwp/.github/issues/1257), [#1258](https://github.com/lightspeedwp/.github/issues/1258), [#1259](https://github.com/lightspeedwp/.github/issues/1259), [#1260](https://github.com/lightspeedwp/.github/issues/1260))
