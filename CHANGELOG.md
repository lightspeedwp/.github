...
- **SpecKit Folder Organization Refactoring & Quality Audit** — Added specification (013) for auditing `.github/specs/` structure, creating centralized catalog, and establishing quality governance. Includes catalog, maintenance procedures, audit framework, and quality checklist. ([PR #3348](https://github.com/lightspeedwp/.github/pull/3348))
