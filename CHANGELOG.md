...
- canonical issue fields + metadata backfill automation ([PR #433](https://github.com/lightspeedwp/.github/pull/433))
- harden canonical seeding with policy-gated cleanup ([PR #451](https://github.com/lightspeedwp/.github/pull/451))
- scope README regen and enforce reviewer ordering ([PR #452](https://github.com/lightspeedwp/.github/pull/452))
- add aging and SLA annotations ([PR #453](https://github.com/lightspeedwp/.github/pull/453))
- Phase 2 Complete — Comprehensive README Frontmatter Standardization ([PR #699](https://github.com/lightspeedwp/.github/pull/699))
- Implement Awesome GitHub site MVP ([PR #755](https://github.com/lightspeedwp/.github/pull/755))
- header with nav dropdowns, theme toggle, mobile burger + drawer ([PR #856](https://github.com/lightspeedwp/.github/pull/856))
- footer component — always-dark, four columns, halo, links ([PR #860](https://github.com/lightspeedwp/.github/pull/860))
- homepage — all 5 blocks wired to live data ([PR #862](https://github.com/lightspeedwp/.github/pull/862))
- WapuuHero component, wapuu asset map, all page-type assignments ([PR #865](https://github.com/lightspeedwp/.github/pull/865))
- learn centre, track cards, lesson reader, localStorage progress ([PR #873](https://github.com/lightspeedwp/.github/pull/873))

### Fixed

- stabilise workflows for v0.4.0 release ([PR #390](https://github.com/lightspeedwp/.github/pull/390))
- fix: command-gate release workflow and harden permissions ([PR #413](https://github.com/lightspeedwp/.github/pull/413))
...
- implement issue #419 labeler hardening ([PR #427](https://github.com/lightspeedwp/.github/pull/427))
- execute canonical label sync in workflow ([PR #450](https://github.com/lightspeedwp/.github/pull/450))
- fix: add substantive content to stub files and remediate footer duplication ([PR #574](https://github.com/lightspeedwp/.github/pull/574))
- address open review issues — ARIA regressions, focus trap, resize lock, branch event, aria-current ([PR #857](https://github.com/lightspeedwp/.github/pull/857))
- theme-toggle syntax error, aria-expanded on Escape, drawer z-index stacking ([PR #858](https://github.com/lightspeedwp/.github/pull/858))

### Changed

- Conduct audit of governance and change management documentation ([PR #331](https://github.com/lightspeedwp/.github/pull/331))
...
- Chore/wider skills governance cleanup ([PR #376](https://github.com/lightspeedwp/.github/pull/376))
- Copilot/automatically merge pr 373 ([PR #377](https://github.com/lightspeedwp/.github/pull/377))
...
- Complete #17 shared .github adoption guide and child audits ([PR #411](https://github.com/lightspeedwp/.github/pull/411))
- Close issue #32 child labeling gaps ([PR #412](https://github.com/lightspeedwp/.github/pull/412))
...
- docs: define downstream override policy for org defaults ([PR #421](https://github.com/lightspeedwp/.github/pull/421))
- audit: governance and change-management documentation review ([PR #426](https://github.com/lightspeedwp/.github/pull/426))
- docs: scaffold adoption governance workstream pack ([PR #428](https://github.com/lightspeedwp/.github/pull/428))
- docs: fix stale governance internal references ([PR #438](https://github.com/lightspeedwp/.github/pull/438))
- docs(governance): define canonical instruction reference policy ([PR #439](https://github.com/lightspeedwp/.github/pull/439))
- docs(governance): add revision log process ([PR #440](https://github.com/lightspeedwp/.github/pull/440))
...
- test: validate workflow/agent imports/includes with smoke tests (#63) ([PR #454](https://github.com/lightspeedwp/.github/pull/454))
- chore(workflows): migrate release/labeling bash logic to Node scripts ([PR #456](https://github.com/lightspeedwp/.github/pull/456))
- ci: add Husky pre-push test gate and docs (#62) ([PR #458](https://github.com/lightspeedwp/.github/pull/458))
...
- chore(wave2a): kickoff #465 issues.agent execution ([PR #497](https://github.com/lightspeedwp/.github/pull/497))
- chore(wave2a): execute #466 labeling.agent parity slice ([PR #499](https://github.com/lightspeedwp/.github/pull/499))
- chore(wave2a): execute #467 linting.agent parity slice ([PR #500](https://github.com/lightspeedwp/.github/pull/500))
- chore(wave2a): execute #468 meta.agent parity slice ([PR #502](https://github.com/lightspeedwp/.github/pull/502))
- docs(wave2a): execute #469 metrics.agent tracking slice ([PR #511](https://github.com/lightspeedwp/.github/pull/511))
- fix/plan: footer remediation + branding meta agent planning ([PR #534](https://github.com/lightspeedwp/.github/pull/534))
- Wave 5: Mermaid Accessibility Compliance + README Frontmatter Updates ([PR #696](https://github.com/lightspeedwp/.github/pull/696))
...
- feat: add WCEU 2026 talk page and polish site shell ([PR #769](https://github.com/lightspeedwp/.github/pull/769))
