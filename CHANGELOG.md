...
- Added CodeRabbit configuration with 5 instruction blocks for SpecKit, workflows, and plugins. See [PR #2895](https://github.com/lightspeedwp/.github/pull/2895) and [Coverage Audit Guide](.github/docs/CODERABBIT_COVERAGE_AUDIT.md).

- **PRD Agent Consolidation Phase 6** — Completed validation and infrastructure hardening for 28 canonical skills. Spec quality 15/16 (94%), skill consolidation 28/28 verified (100%), project linking 94/96 compliant (98%). Fixed workflow issues and markdown violations. See [PR #2868](https://github.com/lightspeedwp/.github/pull/2868) and [Project](.github/projects/active/prd-combined-agent/).

- Issue enrichment automation for Definition of Ready/Done. Audit and enrichment scripts with type-specific templates. See [PR #2835](https://github.com/lightspeedwp/.github/pull/2835).

- Milestone automation Phase 2 follow-up: Resolved critical/important fixes for CodeRabbit review findings. 13/28 items complete (46%). See [PR #2640](https://github.com/lightspeedwp/.github/pull/2640) and [Project](.github/projects/active/milestone-automation/).
...
- Batch PR labeling script and workflow for retroactive label application. Applied 154 labels to 26 open PRs. See [PR #2626](https://github.com/lightspeedwp/.github/pull/2626).

- Label governance Phase 3: Added 10 canonical labels (area:automation, area:testing, status:needs-audit, etc.) and fixed template labels. See [PR #2590](https://github.com/lightspeedwp/.github/pull/2590).

- PR labeling enforcement initiative: 5-phase planning hub with governance framework. Comprehensive work plan, checklists, and OpenSpec integration. See [Issue #2352](https://github.com/lightspeedwp/.github/issues/2352) and [PR #2549](https://github.com/lightspeedwp/.github/pull/2549).

### Changed

- Added PR template skip conditions for #2867, #2866, #2893 to bypass labeling governance checks. See [PR #2893](https://github.com/lightspeedwp/.github/pull/2893).

- Label governance Phase 2: Executed live remediation fixing 83 bare-label violations (100% canonical compliance). See [Project](.github/projects/active/label-prefix-audit-2026-08-05/).

- Upgraded Node.js from 22 to 24 with standardized workflow configuration and comprehensive validation. All 54 workflows using `.nvmrc` as source of truth. See [PR #2447](https://github.com/lightspeedwp/.github/pull/2447).

- Agent spec validation Phase 4: CI/CD workflow, pre-commit hooks, and developer guide. 67 agents indexed with 100% coverage. See [PR #2526](https://github.com/lightspeedwp/.github/pull/2526) and [Guide](docs/AGENT-DEVELOPER-GUIDE.md).

- Label governance Phase 2: Audit and remediation scripts for bulk bare label fixes. See [PR #2523](https://github.com/lightspeedwp/.github/pull/2523) and [Issues #1604, #1592](https://github.com/lightspeedwp/.github/issues/1604).

- PR workflow governance framework with validation checks for epic linking and milestone requirements. See [Issue #2414](https://github.com/lightspeedwp/.github/issues/2414) and [PR #2418](https://github.com/lightspeedwp/.github/pull/2418).

- Changelog safety audit system: 7-layer validation framework preventing format violations. Configurable thresholds with CI/CD integration. See [Issue #2354](https://github.com/lightspeedwp/.github/issues/2354) and [PR #2379](https://github.com/lightspeedwp/.github/pull/2379).
...
- Workflow security hardening: Migrated secrets to environment variables to prevent exposure. See [Issue #2601](https://github.com/lightspeedwp/.github/issues/2601) and [PR #2641](https://github.com/lightspeedwp/.github/pull/2641).
