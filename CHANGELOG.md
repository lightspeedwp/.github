...
- **SpecKit Folder Organization Refactoring & Quality Audit Specification** — Added comprehensive specification (013-spec-folder-refactor) for auditing `.github/specs/` structure, creating centralized catalog, auditing quality across all 12 specs against 8-dimension framework, and establishing maintenance procedures. Includes 5 prioritized user stories, 12 functional requirements, 9 measurable success criteria. ([PR #3348](https://github.com/lightspeedwp/.github/pull/3348))
