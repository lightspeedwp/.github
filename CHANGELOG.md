...
- **Org issue-field writer infrastructure (MVP for #1145)** — Scaffolded org-level issue field writer for field initialisation across GitHub Projects. Added documentation for field ID mapping configuration (`.github/issue-field-ids.yml`), permission setup, and integration points. Marked functionality as pending implementation of GitHub API permissions and field ID configuration. Updated [docs/ISSUE_FIELDS.md](./docs/ISSUE_FIELDS.md) with complete specification, added planning system documentation for GitHub Projects creation (4 planning docs: INDEX.md, PLANNING.md, SUMMARY.md, ISSUES.md with epic and story templates). ([PR #1151](https://github.com/lightspeedwp/.github/pull/1151))
