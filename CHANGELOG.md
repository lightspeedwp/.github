...
- **Dependabot Scope Fix** — Added /website npm scanning and area:dependencies labels to dependabot.yml, added on develop in #1059 but never back-ported to main; needed for Mergify auto-merge. ([PR TBD]())
