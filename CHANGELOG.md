...
- **Test Check on Every Pull Request** — Pull requests now run the full test suite and fail only on failures they introduce, so broken tests can no longer merge unnoticed. (#3479)
