...
- **GitHub Label Audit & Consolidation — MVP Complete** — Comprehensive audit of 169 canonical labels across 15 families, identifying type label governance gap (type:decision unmapped in issue-types.yml) and 12 governance policy misalignments. Deliverables: (1) **Audit Report** (`007-audit-report.md`) with 2 critical findings and prioritised recommendations; (2) **Label Inventory** (CSV and JSON) cataloguing all 169 labels by family, status, and mappings; (3) **Evidence Archive** with structured findings traceable to source files (canonical-labels.json, issue-types.json, governance-policy.json, label-families.json, archived-workflows.json, documentation-references.json); (4) **Specification Updates** correcting baseline data (147→169 labels, 25→26 type labels); (5) **Constitution Amendment** documenting corrected label counts for governance reference. Impact: Governance team now has complete visibility into label taxonomy, identified governance gaps requiring decision-making, and foundational data for planned consolidation strategy (Phase 2). User Story 1 (Reconciliation) complete; Phase 2 (Duplicates analysis) ready for prioritisation. See `.github/specs/008-label-audit-consolidation/` and `.github/reports/audits/2026-09-14-label-audit/`. ([PR #3362](https://github.com/lightspeedwp/.github/pull/3362))
