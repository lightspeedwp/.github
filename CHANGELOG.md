...
- **Label Ownership Reconciled** — Native issue types now take precedence, whole-word fallback and v5 file matchers stop routing, labeler and agent conflicts. ([PR #3549](https://github.com/lightspeedwp/.github/pull/3549), [#3545](https://github.com/lightspeedwp/.github/issues/3545))
