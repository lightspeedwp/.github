...
- **Requirements Quality Checklist Framework — Phase 4: Domain-Specific Variants** — Added 4 domain variants (UX, API, Security, Performance) with 18 items each for domain-focused specification quality. (#3361)
- **Requirements Quality Checklist Framework — Phase 5: Multi-Audience Guidance** — Added audience-specific guidance for 4 user roles with tailored presentations and decision workflows. (#3361)
