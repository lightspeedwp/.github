 ...
 * Types: 38 authorized branch types (per Constitution Principle V)
...
function formatErrorMessage(branchName, validationResult) {
  ...
  switch (mainError) {
    ...
    case 'invalid_type':
      message = `❌ Invalid type '${invalidType}'. Not recognized.\n\nAllowed types (38):\n  feat fix hotfix release refactor chore task doc docs test perf\n  ci build deps security design a11y ux i18n ops proto ds api\n  schema telemetry content seo config migrate qa uat audit codex\n  revert research aiops automation epic\n\nExample: feat/user-auth-improvements`;
      break;
...
export { validateBranchName, formatErrorMessage, AUTHORIZED_TYPES, FORBIDDEN_PREFIXES };
