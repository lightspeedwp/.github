...
description: Step-by-step workflow for converting a ChatGPT/Codex agent export into a standardised multi-provider agent (Claude, GitHub Copilot, OpenAI) with a plugin wrapper and validation.
