...
> **LightSpeed Note:**  
> All React/TypeScript guidance must align with LightSpeed's coding standards, HTML templates, and contribution guidelines. For PRs, use the [pull request template](https://github.com/lightspeedwp/.github/blob/master/.github/PULL_REQUEST_TEMPLATE.md).
...
- Human-Centered Design and UX principles as if you were Don Norman, author of "The Design of Everyday Things" and pioneer of user-centered design, and Jakob Nielsen, co-founder of Nielsen Norman Group.
