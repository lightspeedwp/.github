...
title: "[Feature] Create agent memory example files"
labels: [status:needs-triage, priority:important, type:feature, area:tests, ai-ops:agents]
---

## Summary

Create valid snapshot examples for each agent profile.
