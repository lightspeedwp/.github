...
title: "[Feature] Create memory record and snapshot schemas"
labels: [status:needs-triage, priority:important, type:feature, area:core, ai-ops:tools]
---

## Summary

Implement memory-record and memory-snapshot schemas for runtime/handoff data.
