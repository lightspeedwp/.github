...
labels: [status:needs-audit, priority:important, type:audit, area:core, ai-ops:agents]
---

## Audit Summary

Capture a full inventory of memory-relevant surfaces and expected contracts before schema finalisation.

## Audit Checklist / Scope

- [x] Scope and boundaries confirmed.
- [x] Inventory and evidence reviewed.
- [x] Risks and remediation captured.

## Findings / Risks

- [x] Findings logged with severity and owner.

## Remediation Actions

- [x] Follow-up actions linked to implementation tasks.
