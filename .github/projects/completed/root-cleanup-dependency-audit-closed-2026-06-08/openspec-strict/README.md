...
This set is prepared for strict /opsx:propose parsing and execution.

## Run Order

1. parents/01-epic-root-cleanup-and-dependency-rationalisation.md
2. children/01-1-task-finalise-dependency-rationalisation.md
3. children/01-2-task-complete-root-document-relocation.md
4. children/01-3-task-finalise-report-artifact-and-script-paths.md
5. children/01-4-task-triage-legacy-root-files-and-closeout.md
