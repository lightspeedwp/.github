...
authors: ["Codex"]
license: "GPL-3.0"
tags: ["inventory", "memory", "agents", "skills", "baseline"]
domain: "governance"
stability: "active"
---

# Inventory Baseline (2026-05-26)

## Summary

- Agent specs discovered: **19**
- Skill entrypoints discovered: **89**
- Target profiles: **108**
- Target examples: **108**
...
- `design-md-agent`: 86
- `lightspeed-frontmatter-audit`: 1
- `lightspeed-label-governance`: 1
- `lightspeed-pr-review`: 1

## Baseline Lock Expectations
