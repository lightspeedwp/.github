...
labels: [status:needs-triage, priority:normal, type:maintenance, area:documentation, area:core]
---

## Summary

Resolve schema-readme inconsistencies and stale references in schema docs.
