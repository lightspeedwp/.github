...
| # | Task | Time | Priority |
|---|------|------|----------|
| 1.1 | Remove non-existent label reference | 5m | 🔴 CRITICAL |
| 1.2 | Add missing type label aliases | 30m | 🔴 CRITICAL |
| 1.3 | Implement issue-body labeling rules | 3-4h | 🔴 CRITICAL |
| 1.4 | Fix template-enforcement silent reopening | 2-3h | 🔴 CRITICAL |
| 1.5 | Add issue DoD validation | 2-3h | 🔴 CRITICAL |
| **Total** | | **11.5h** | |
...
| # | Task | Time | Priority |
|---|------|------|----------|
| 2.1 | Implement PR merge blocker (DoD check) | 3-4h | 🟠 HIGH |
| 2.2 | Auto-populate custom fields | 4-5h | 🟠 HIGH |
| 2.3 | Template-aware type detection | 1-2h | 🟠 MEDIUM |
| **Total** | | **15h** | |
...
| # | Task | Time | Priority |
|---|------|------|----------|
| 3.1 | Create AI agent issue creation guide | 2h | 🟢 MEDIUM |
| 3.2 | Update AGENTS.md with best practices | 2h | 🟢 MEDIUM |
| 3.3 | End-to-end testing & validation | 4h | 🟢 MEDIUM |
