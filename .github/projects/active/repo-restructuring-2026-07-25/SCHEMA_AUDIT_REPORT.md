...
- `schemas/` (visible root): 25 files + README (visible, portable, npm-referenced)
- `.schemas/` (hidden target): 23 files + README (missing `agent-config.example.md` and `examples/`)
