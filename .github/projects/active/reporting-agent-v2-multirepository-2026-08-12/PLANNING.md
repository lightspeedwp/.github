...
status: "active"
related_issues:
  - "#1898 — Master epic for Reporting Agent v2"
...
- **Arbitrary custom frontmatter fields** — Out of scope (repo-specific v2 fields: block-name, block-slug, theme-name, theme-slug are supported)
