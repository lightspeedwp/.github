...
├── IMPLEMENTATION_PLAN_TEMPLATE.md (template for final plan)
├── requirements.md (generated by OpenSpec)
├── flow-diagrams.md (generated during design phase)
├── adrs/ (architectural decision records)
│   └── ADR-001-release-flow-architecture.md
├── design/ (design documents)
│   └── release-workflow-design.yml
...
- **Audit Report:** [RELEASE_PROCESS_AUDIT_REPORT.md](../../../../../../private/tmp/.../RELEASE_PROCESS_AUDIT_REPORT.md)
- **Main Audit Findings:** [memory/release-process-audit-findings.md](../../../memory/release-process-audit-findings.md)
- **GitHub Docs - Semantic Versioning:** <https://semver.org/>
- **GitHub Docs - Keep a Changelog:** <https://keepachangelog.com/>
- **Your RELEASE_PROCESS.md:** [../../docs/RELEASE_PROCESS.md](../../docs/RELEASE_PROCESS.md)
