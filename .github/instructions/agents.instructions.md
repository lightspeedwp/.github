...
#### 🏷️ [Badges Agent](./agents/badges.instructions.md)
...
#### 📄 [Header-Footer Agent](./agents/header-footer.instructions.md)
- **Purpose**: Automates header and footer insertion in documentation files
- **Integration**: Works with [header-footer.yml](../workflows/header-footer.yml) workflow
- **Prompts**: Uses [header-footer.prompt.md](../prompts/agents/header-footer.prompt.md)
