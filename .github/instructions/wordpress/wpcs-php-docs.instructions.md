...
- Use `@param` for each parameter with its type, variable name and description. Document default values and nullable parameters.
 ...
 *
 * This helper function applies the current tax rate to a base price and returns the total.
 *
 * @since 1.2.0
 *
 * @param float $price    Base price before tax.
 * @param float $tax_rate Tax rate as a decimal (e.g. 0.2 for 20%).
 * @return float Total price including tax.
 */
function ls_calculate_total( $price, $tax_rate ) {
