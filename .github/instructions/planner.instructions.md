...
applyTo: [".github/agents/planner.agent.md", "scripts/agents/planner.agent.js", ".github/workflows/planner.yml"]
status: "planned"
...
- [planner.agent.md](../agents/planner.agent.md) — Agent specification (to be created)
