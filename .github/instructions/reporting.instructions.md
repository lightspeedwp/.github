...
- Store reports under `.githu./.github/reports/{category}/` with kebab-case names and dates/versions.
...
- **Good:** `.githu./.github/reports/analysis/code-complexity-analysis-2025-12-08.md` or `.githu./.github/reports/progress/weekly-summary-2025-w50.md`.
...
- **Location**: All reports must be stored in a relevant subfolder within `.githu./.github/reports/`.
...
- **Canonical path:** `.githu./.github/reports/{category}/`
- **Progress tracking:** use `.githu./.github/reports/progress/` for multi-day or multi-week project updates.
...
- Progress examples:
  - `.githu./.github/reports/progress/daily-update-2025-12-11.md`
  - `.githu./.github/reports/progress/weekly-summary-2025-w50.md`
