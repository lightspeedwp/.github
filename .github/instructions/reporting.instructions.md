...
This document outlines where various reports generated by our scripts and workflows should be stored.
...
**Purpose**: Logs and outputs from AI agent executions.
**File Naming**: `{agent-name}-{task-id}-{YYYY-MM-DD}.{log|md|json}`
**Example**: `labeling-agent-pr-123-2025-12-08.log`
