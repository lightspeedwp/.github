...
**Location**: `.github/labels.yml` (moved from `.github/automation/labels.yml`)
...
**Location**: `.github/labeler.yml` (moved from `.github/automation/labeler.yml`)
...
**Location**: `.github/issue-types.yml` (moved from `.github/automation/issue-types.yml`)
...
| -------------- | -------------------------------------------------------------------- | -------------------------------------- |
| Agent Spec     | [.github/agents/labeling.agent.md](../agents/labeling.agent.md)      | Master specification and configuration |
| Workflow       | [.github/workflows/labeling.yml](../workflows/labeling.yml)          | GitHub Actions automation trigger      |
| Labels         | [.github/labels.yml](../labels.yml)                                  | Canonical label definitions            |
| Rules          | [.github/labeler.yml](../labeler.yml)                                | Pattern-to-label mapping engine        |
| Types          | [.github/issue-types.yml](../issue-types.yml)                        | Issue type to label mappings           |
