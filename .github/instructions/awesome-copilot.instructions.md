...
4. **Keep files up to date:**  
   Track changes in the dynamic indexes and update this file as standards evolve.
...
- **Frontmatter:**  
  All files include LightSpeedWP standard frontmatter for automation, search, and agent governance.
- **Updates:**  
  Keep this file and all referenced indexes up to date as standards evolve.
- **Questions:**  
  Open a [Discussion](https://github.com/orgs/lightspeedwp/discussions) or contact [support@lightspeedwp.agency](mailto:support@lightspeedwp.agency).
