...
- [ ] Docs updated`;
  ...
  it("should handle long YAML frontmatter (10+ lines)", () => {
    const content = `---
name: "Long Frontmatter"
description: "This frontmatter spans more than 10 lines"
version: "1.0.0"
author: "Test Author"
date: "2026-08-05"
tags:
...
This content follows long frontmatter.`;

    const { body } = extractFrontmatterSafely(content);

    expect(body).toContain("## Content Section");
    expect(body).toContain("This content follows long frontmatter.");
