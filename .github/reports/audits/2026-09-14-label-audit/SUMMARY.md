...
| Duplicate labels       | 23 pairs checked: 5 merges approved, 5 proposals needing a decision, the rest kept on purpose                                                                                                                         |
...
4. **Decide the 5 duplicate proposals** and the three `CLAUDE.md` labels in the Stage 1 `[LABEL-UPDATE-REQUEST]` (T046).
