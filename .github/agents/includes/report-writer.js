...
function generateReport(telemetry = null) {
    ...
    report += `---\n\n`;
    report += `## 📚 Reference\n\n`;
    report += `- **Canonical Labels:** [.github/automation/labels.yml](../../automation/labels.yml)\n`;
    report += `- **Labeler Rules:** [.github/automation/labeler.yml](../../automation/labeler.yml)\n`;
    report += `- **Agent Documentation:** [Labeling Agent Usage](../../../docs/LABELING_AGENT_USAGE.md)\n\n`;
