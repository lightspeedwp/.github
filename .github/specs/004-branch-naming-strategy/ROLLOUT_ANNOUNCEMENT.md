...
Effective immediately, **all new branches in LightSpeed repositories must follow this pattern:**
...
Using these will **block PR creation** and require branch deletion/recreation.
...
- Enforced in: 5 pilot repos
- Mode: Soft enforcement (warnings, guidance, no blocking)
...
- Metrics dashboard: Available at [org dashboard URL]
...
3. Cherry-pick commits: `git cherry-pick temp-old-name..HEAD`
...
[View Implementation Plan](./.github/specs/004-branch-naming-strategy/plan.md)
