...
- **FR-008**: Validation workflow MUST run on every PR that modifies CHANGELOG.md and provides feedback via GitHub PR comments or status checks, except pull requests the gate skips before inspecting files (Dependabot and docs-bot authors)
