#!/usr/bin/env bats
# Test: label-heuristics.bats
# Description: Bats tests for label-heuristics.js utility script
...
setup() {
  ...
  SCRIPT="$(cd "$(dirname "$BATS_TEST_FILENAME")/../../scripts/utility" && pwd)/label-heuristics.js"
  chmod +x "$SCRIPT"
}
