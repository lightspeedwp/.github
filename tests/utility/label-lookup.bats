#!/usr/bin/env bats
# Test: label-lookup.bats
# Description: Bats tests for label-lookup.js utility script
...
setup() {
  ...
  SCRIPT="$(cd "$(dirname "$BATS_TEST_FILENAME")/../../scripts/utility" && pwd)/label-lookup.js"
  chmod +x "$SCRIPT"
}
