#!/usr/bin/env bats
# Test: labeler-utils.bats
# Description: Bats tests for labeler-utils.js utility script
...
setup() {
  ...
  SCRIPT="$(cd "$(dirname "$BATS_TEST_FILENAME")/../../scripts/utility" && pwd)/labeler-utils.js"
  chmod +x "$SCRIPT"
}
