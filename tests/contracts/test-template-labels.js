...
const labelsYaml = yaml.load(fs.readFileSync(path.resolve('.github/automation/labels.yml'), 'utf8'));
...
const templates = fs.existsSync(templatesDir) ? findTemplates(templatesDir) : [];
