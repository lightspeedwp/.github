        ...
        () => {
            ...
            const readLiteralBlock = (startIndex, parentIndent) => {
                ...
                for (; index < lines.length; index++) {
                    ...
                    const lineIndent =
                        rawLine.length - rawLine.trimLeft().length;
                ...
                if (trimmed.startsWith('- ')) {
                    if (currentKey === 'items') {
                        ...
                        if (restOfLine) {
                            ...
                            if (colonIndex > -1) {
                                const key = restOfLine
                                    .substring(0, colonIndex)
                                    .trim();
                                const value = restOfLine
                    ...
                    if (leadingSpaces === 0) {
                        ...
                        if (value) {
                            ...
                            if (value.startsWith('[') && value.endsWith(']')) {
                                ...
                                const { content: blockContent, nextIndex } =
                                    readLiteralBlock(i + 1, leadingSpaces);
