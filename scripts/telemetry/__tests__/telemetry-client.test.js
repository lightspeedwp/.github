...
describe("TelemetryClient", () => {
  ...
  beforeEach(() => {
    ...
    savedEnv = {
      ...
      CI: process.env.CI,
      TELEMETRY_INCLUDE_RESTRICTED: process.env.TELEMETRY_INCLUDE_RESTRICTED,
    };
  ...
  afterEach(() => {
    ...
    if (savedEnv.TELEMETRY_INCLUDE_RESTRICTED !== undefined) {
      process.env.TELEMETRY_INCLUDE_RESTRICTED =
        savedEnv.TELEMETRY_INCLUDE_RESTRICTED;
    } else {
      delete process.env.TELEMETRY_INCLUDE_RESTRICTED;
    }
  });
