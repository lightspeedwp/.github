...
```javascript
const { createTelemetryClient } = require('./.github/scripts/telemetry/telemetry-client.js');
const { EVENT_SCHEMAS } = require('./.github/scripts/telemetry/event-schemas.js');
...
| `.github/scripts/workflows/metrics-collection-orchestrator.cjs` | 3 | Metrics collection across repositories |
| `.github/scripts/workflows/metrics-reporting-orchestrator.cjs` | 1 | Metrics report generation |
