...
describe('validate-structure', () => {
  ...
  describe('validateStructure - required folders', () => {
    it('should pass when all required folders exist with README.md', () => {
      ...
      const errors = validateStructure(root, mockFS.existsSync, mockFS.statSync)
    ...
    it('should fail when required folder is missing', () => {
      ...
      const errors = validateStructure(root, mockFS.existsSync, mockFS.statSync)
      expect(errors.some((e) => e.includes('Missing required directory: agents'))).toBe(true)
    })
    ...
    it('should fail when index file is missing from required folder', () => {
      ...
      const errors = validateStructure(root, mockFS.existsSync, mockFS.statSync)
      expect(errors.some((e) => e.includes('Missing README.md or index.md') && e.includes('schemas'))).toBe(true)
    })
  ...
  describe('validateStructure - pilot plugin', () => {
    ...
    it('should fail when pilot plugin is missing README.md', () => {
      ...
      const errors = validateStructure(root, mockFS.existsSync, mockFS.statSync)
      expect(errors.some((e) => e.includes('Missing pilot plugin file'))).toBe(true)
    })
  })
  ...
  describe('edge cases', () => {
    ...
    it('should pass with mixed README and index files', () => {
      ...
      const indices = ['README.md', 'index.md', 'README.md', 'index.md', 'README.md', 'index.md', 'README.md', 'index.md']
