...
describe('validate-mermaid-syntax', () => {
  describe('extractMermaidDiagrams', () => {
    it('should extract single mermaid diagram from markdown', () => {
      const content = fs.readFileSync(path.join(FIXTURE_DIR, 'valid/graph.md'), 'utf8');
    ...
    it('should extract multiple diagrams from markdown', () => {
      const content = fs.readFileSync(path.join(FIXTURE_DIR, 'valid/multiple-diagrams.md'), 'utf8');
      const diagrams = extractMermaidDiagrams(content);
  ...
  describe('fixture validation', () => {
    ...
    it('should validate valid flowchart fixture', () => {
      const content = fs.readFileSync(path.join(FIXTURE_DIR, 'valid/flowchart.md'), 'utf8');
      const diagrams = extractMermaidDiagrams(content);
    ...
    it('should detect invalid syntax in fixture', () => {
      const content = fs.readFileSync(path.join(FIXTURE_DIR, 'invalid/missing-keyword.md'), 'utf8');
      const diagrams = extractMermaidDiagrams(content);
    ...
    it('should handle valid sequence diagram fixture', () => {
      const content = fs.readFileSync(path.join(FIXTURE_DIR, 'valid/sequencediagram.md'), 'utf8');
      const diagrams = extractMermaidDiagrams(content);
    ...
    it('should handle valid state diagram fixture', () => {
      const content = fs.readFileSync(path.join(FIXTURE_DIR, 'valid/statediagram.md'), 'utf8');
      const diagrams = extractMermaidDiagrams(content);
