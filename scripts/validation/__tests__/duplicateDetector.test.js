...
describe('duplicateDetector', () => {
  ...
  describe('isFuzzyDuplicate', () => {
    ...
    test('should detect slight variations', () => {
      expect(isFuzzyDuplicate('Fixed parser bug', 'Fixed parser bug in core', 0.65)).toBe(true);
    });
  ...
  describe('deduplicateEntries', () => {
    ...
    test('should keep similar but different entries', () => {
      const entries = [{ description: 'Fixed parser' }, { description: 'Fixed lexer' }];
    ...
    test('should use custom threshold', () => {
      const entries = [{ description: 'Fixed parser' }, { description: 'Fixed parser bug' }];
