...
describe('.github/projects/active frontmatter changes (PR)', () => {
  describe('PROJECT_REVIEW_AUDIT_2026-08-21.md', () => {
    ...
    beforeAll(() => {
      frontmatter = extractFrontmatter(readProjectFile('PROJECT_REVIEW_AUDIT_2026-08-21.md'));
    });
  ...
  describe('edge cases', () => {
    ...
    it('throws when a referenced project file does not exist', () => {
      expect(() => readProjectFile('does-not-exist/README.md')).toThrow(/ENOENT|no such file/i);
    });
  });
});
