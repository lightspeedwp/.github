...
describe('auto-update-all.js', () => {
  ...
  describe('OpenSpec Label Detection', () => {
    ...
    it('should assign correct OpenSpec labels', () => {
      ...
      expect(getOpenSpecLabel(specIssue)).toBe('openspec:specification-in-progress');

      const implIssue = 'impl: Build API server';
      expect(getOpenSpecLabel(implIssue)).toBe('openspec:implementation-in-progress');
    });
  });
  ...
  describe('Statistics Tracking', () => {
    ...
    it('should track descriptions updated', () => {
      ...
      expect(stats.issuesDescriptionUpdated + stats.prsDescriptionUpdated).toBe(119);
    });
  });
  ...
  describe('Integration', () => {
    it('should complete full issue update flow', () => {
      ...
      const shouldUpdateDescription = !hasDoRSection(issue.body) || !hasDoDSection(issue.body);
