...
const html = `<!-- Generated by scripts/automation/__tests__/performance/metrics-dashboard.js. Regenerate with: node scripts/automation/__tests__/performance/performance-benchmarking.js && node -e "import('./scripts/automation/__tests__/performance/metrics-dashboard.js').then(async ({ generateHTMLDashboard, generateMarkdownReport }) => { const { readFileSync, writeFileSync, mkdirSync } = await import('node:fs'); const { default: path } = await import('node:path'); const { runBenchmarks } = await import('./scripts/automation/__tests__/performance/performance-benchmarking.js'); const results = await runBenchmarks(); const htmlPath = './scripts/automation/__tests__/performance/phase-2b-dashboard.html'; generateHTMLDashboard(results, htmlPath); const markdown = generateMarkdownReport(results); mkdirSync('./.github/projects/active/phase-2b-skills-audit', { recursive: true }); writeFileSync('./.github/projects/active/phase-2b-skills-audit/PHASE-2B-VALIDATION-RESULTS.md', markdown); });" -->
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
